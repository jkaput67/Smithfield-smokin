...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_1helq0jejn69h2cg.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_1helq0jejn69h2cg.getPreviewDialogWidth(editor);
    var dialogHeight = $_1helq0jejn69h2cg.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_f87zz2jfjn69h2cg.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_dkf54sjcjn69h2cg = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_dkf54sjcjn69h2cg.open(editor);
    });
  };
  var $_79wubjjbjn69h2cg = { register: register };
  ...
  var $_5ouxtjjhjn69h2cg = { register: register$1 };

  global.add('preview', function (editor) {
    $_79wubjjbjn69h2cg.register(editor);
    $_5ouxtjjhjn69h2cg.register(editor);
  });
  function Plugin () {
  }
