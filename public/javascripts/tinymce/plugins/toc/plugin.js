...
var toc = (function () {
  ...
  var $_5e4koosajn69h5dx = { create: create };

  var tocId = $_5e4koosajn69h5dx.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_ah5nrus9jn69h5dw.getTocClass(editor);
    var headerTag = $_ah5nrus9jn69h5dw.getTocHeader(editor);
    var selector = generateSelector($_ah5nrus9jn69h5dw.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_ah5nrus9jn69h5dw.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_ah5nrus9jn69h5dw.getTocHeader(editor), global$2.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_7tsm99s5jn69h5dp.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_7tsm99s5jn69h5dp.updateToc(editor);
    });
  };
  var $_3rl47ms4jn69h5dn = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_ah5nrus9jn69h5dw.getTocClass(editor);
  ...
  var $_esz3orsbjn69h5dz = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_7tsm99s5jn69h5dp.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_ah5nrus9jn69h5dw.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_8nab5sscjn69h5e2 = { register: register$1 };

  global.add('toc', function (editor) {
    $_3rl47ms4jn69h5dn.register(editor);
    $_8nab5sscjn69h5e2.register(editor);
    $_esz3orsbjn69h5dz.setup(editor);
  });
  function Plugin () {
  }
