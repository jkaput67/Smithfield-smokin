...
var help = (function () {
  ...
  var $_5y93ysbljn69h0qj = { shortcuts: shortcuts };
  ...
  var makeTab = function () {
    ...
    var shortcutLisString = map($_5y93ysbljn69h0qj.shortcuts, function (shortcut) {
  ...
  var $_2h76ffbfjn69h0p7 = { makeTab: makeTab };
  ...
  var $_4iir3bbnjn69h0qm = { makeTab: makeTab$1 };
  ...
  var $_6ylmw6btjn69h0rt = { makeRow: makeRow };
  ...
  var open = function (editor, pluginUrl) {
    return function () {
      editor.windowManager.open({
        ...
        layout: 'flex',
        body: [
          $_2h76ffbfjn69h0p7.makeTab(),
          $_4iir3bbnjn69h0qm.makeTab(editor)
        ],
        buttons: $_6ylmw6btjn69h0rt.makeRow(),
  ...
  var $_5vt4ttbejn69h0p3 = { open: open };

  var register = function (editor, pluginUrl) {
    editor.addCommand('mceHelp', $_5vt4ttbejn69h0p3.open(editor, pluginUrl));
  };
  var $_7ocsqmbdjn69h0p1 = { register: register };

  var register$1 = function (editor, pluginUrl) {
    editor.addButton('help', {
      icon: 'help',
      onclick: $_5vt4ttbejn69h0p3.open(editor, pluginUrl)
    });
  ...
  var $_b3ffyebvjn69h0rw = { register: register$1 };

  global.add('help', function (editor, pluginUrl) {
    $_b3ffyebvjn69h0rw.register(editor, pluginUrl);
    $_7ocsqmbdjn69h0p1.register(editor, pluginUrl);
