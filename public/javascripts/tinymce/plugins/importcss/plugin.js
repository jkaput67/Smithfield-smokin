...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_be2ifffbjn69h1n1.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_be2ifffbjn69h1n1.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_be2ifffbjn69h1n1.getSelectorConverter(editor)) {
      selectorConverter = $_be2ifffbjn69h1n1.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_be2ifffbjn69h1n1.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_be2ifffbjn69h1n1.getCssGroups(editor));
      ...
      if (!$_be2ifffbjn69h1n1.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_be2ifffbjn69h1n1.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_e9jl6df6jn69h1mp.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_7j0wtvf5jn69h1mm = { get: get };

  global.add('importcss', function (editor) {
    $_e9jl6df6jn69h1mp.setup(editor);
    return $_7j0wtvf5jn69h1mm.get(editor);
  });
  function Plugin () {
  }
