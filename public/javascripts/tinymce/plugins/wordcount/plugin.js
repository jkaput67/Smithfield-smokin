...
var wordcount = (function () {
  ...
  var $_3c5so0tkjn69h5lx = {
    each: each,
    map: map
  };

  var SETS$1 = $_8jmte3tijn69h5lq.SETS;
  var OTHER = $_8jmte3tijn69h5lq.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_3c5so0tkjn69h5lx.map(string.split(''), memoized);
  };
  var $_f55zfrtjjn69h5lv = { classify: classify };

  var ci = $_8jmte3tijn69h5lq.characterIndices;
  ...
  var $_egbyowtljn69h5m0 = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_8jmte3tijn69h5lq.EMPTY_STRING;
  var WHITESPACE$1 = $_8jmte3tijn69h5lq.WHITESPACE;
  var PUNCTUATION$1 = $_8jmte3tijn69h5lq.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_f55zfrtjjn69h5lv.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_egbyowtljn69h5m0.isWordBoundary(map, i)) {
  ...
  var $_547mq0thjn69h5lj = { getWords: getWords };
  ...
  var getCount = function (editor) {
    return $_547mq0thjn69h5lj.getWords(getTextContent(editor)).length;
  };
  var $_tyj7gtejn69h5le = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_tyj7gtejn69h5le.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_5hhot1tdjn69h5lc = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$4.translate([
        '{0} words',
        $_tyj7gtejn69h5le.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_cn02mtmjn69h5m2 = { setup: setup };

  global.add('wordcount', function (editor) {
    $_cn02mtmjn69h5m2.setup(editor);
    return $_5hhot1tdjn69h5lc.get(editor);
  });
  function Plugin () {
  }
