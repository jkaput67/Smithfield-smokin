...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_2ytxok92jn69h04d.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_2ytxok92jn69h04d.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_2ytxok92jn69h04d.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_2ytxok92jn69h04d.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_2ytxok92jn69h04d.getAutoResizeBottomMargin(editor);
    ...
    if ($_2ytxok92jn69h04d.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_9wnkji8zjn69h048.resize(editor, oldSize);
    });
  };
  var $_6c6udg8yjn69h046 = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_6c6udg8yjn69h046.register(editor, oldSize);
      $_9wnkji8zjn69h048.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
