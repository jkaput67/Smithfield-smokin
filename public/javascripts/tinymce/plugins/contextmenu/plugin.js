...
var contextmenu = (function () {
  ...
  var $_2euhx7aujn69h0lh = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_fxsolhatjn69h0le.getContextMenu(editor);
  ...
  var $_6nafa6axjn69h0ls = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_fxsolhatjn69h0le.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_6nafa6axjn69h0ls.show(editor, $_2euhx7aujn69h0lh.getPos(editor, e), visibleState, menu);
    });
  };
  var $_dmdi2tasjn69h0lc = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_dmdi2tasjn69h0lc.setup(editor, visibleState, menu);
    return $_b2kmetarjn69h0l5.get(visibleState);
  });
  function Plugin () {
  }
