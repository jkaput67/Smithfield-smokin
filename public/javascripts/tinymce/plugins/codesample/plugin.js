...
var codesample = (function () {
  ...
  var getSelectedCodeSample = function (editor) {
    ...
    if ($_5oq3tiafjn69h0f0.isCodeSample(node)) {
      return node;
    }
    return null;
  };
  ...
  var getLanguages$1 = function (editor) {
    ...
    var customLanguages = $_g71nvlaajn69h0cb.getLanguages(editor);
    return customLanguages ? customLanguages : defaultLanguages;
  };
  var getCurrentLanguage = function (editor) {
    var matches;
    var node = $_348l2iacjn69h0cf.getSelectedCodeSample(editor);
    if (node) {
  ...
  var $_4g84j1agjn69h0f5 = {
    getLanguages: getLanguages$1,
    getCurrentLanguage: getCurrentLanguage
  };

  var $_d9nltha9jn69h0c8 = {
    open: function (editor) {
      var minWidth = $_g71nvlaajn69h0cb.getDialogMinWidth(editor);
      var minHeight = $_g71nvlaajn69h0cb.getDialogMinHeight(editor);
      var currentLanguage = $_4g84j1agjn69h0f5.getCurrentLanguage(editor);
      var currentLanguages = $_4g84j1agjn69h0f5.getLanguages(editor);
      var currentCode = $_348l2iacjn69h0cf.getCurrentCode(editor);
      editor.windowManager.open({
        ...
        onSubmit: function (e) {
          $_348l2iacjn69h0cf.insertCodeSample(editor, e.data.language, e.data.code);
        }
      });
    }
  };
  ...
  var register = function (editor) {
    editor.addCommand('codesample', function () {
      var node = editor.selection.getNode();
      if (editor.selection.isCollapsed() || $_5oq3tiafjn69h0f0.isCodeSample(node)) {
        $_d9nltha9jn69h0c8.open(editor);
      } else {
        editor.formatter.toggle('code');
      }
    });
  };
  var $_1tnvt3a8jn69h0c7 = { register: register };

  var setup = function (editor) {
    var $ = editor.$;
    editor.on('PreProcess', function (e) {
      $('pre[contenteditable=false]', e.node).filter($_5oq3tiafjn69h0f0.trimArg($_5oq3tiafjn69h0f0.isCodeSample)).each(function (idx, elm) {
    ...
    editor.on('SetContent', function () {
      var unprocessedCodeSamples = $('pre').filter($_5oq3tiafjn69h0f0.trimArg($_5oq3tiafjn69h0f0.isCodeSample)).filter(function (idx, elm) {
  ...
  var $_7bq9xwahjn69h0f9 = { setup: setup };

  var loadCss = function (editor, pluginUrl, addedInlineCss, addedCss) {
    var linkElm;
    var contentCss = $_g71nvlaajn69h0cb.getContentCss(editor);
  ...
  var $_379z04aijn69h0fc = { loadCss: loadCss };
  ...
  var $_8u615zajjn69h0ff = { register: register$1 };

  var addedInlineCss = Cell(false);
  global.add('codesample', function (editor, pluginUrl) {
    var addedCss = Cell(false);
    $_7bq9xwahjn69h0f9.setup(editor);
    $_8u615zajjn69h0ff.register(editor);
    $_1tnvt3a8jn69h0c7.register(editor);
    editor.on('init', function () {
      $_379z04aijn69h0fc.loadCss(editor, pluginUrl, addedInlineCss, addedCss);
    });
    editor.on('dblclick', function (ev) {
      if ($_5oq3tiafjn69h0f0.isCodeSample(ev.target)) {
        $_d9nltha9jn69h0c8.open(editor);
      }
    });
  });
