...
var mobile = (function () {
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_gf0cc6y9jn69h6p2.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_gf0cc6y9jn69h6p2.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_gf0cc6y9jn69h6p2.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_e66j80yejn69h6pz = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_e66j80yejn69h6pz.browsers();
    var oses = $_e66j80yejn69h6pz.oses();
    var browser = $_40tausycjn69h6p3.detectBrowser(browsers, userAgent).fold($_6wg5o5y8jn69h6oj.unknown, $_6wg5o5y8jn69h6oj.nu);
    var os = $_40tausycjn69h6p3.detectOs(oses, userAgent).fold($_cna6h3yajn69h6p3.unknown, $_cna6h3yajn69h6p3.nu);
  ...
  var $_d7lpcuy7jn69h6oj = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_d7lpcuy7jn69h6oj.detect(userAgent);
  });
  var $_bc3j7by4jn69h6no = { detect: detect$3 };
  ...
  var tap = alloy.tap;
  var tapOrClick = $_bc3j7by4jn69h6no.detect().deviceType.isTouch() ? alloy.tap : click;
  ...
  var isComment = function (element) {
    return type(element) === $_7n266gymjn69h6s8.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_7n266gymjn69h6s8.ELEMENT);
  var isText = isType$1($_7n266gymjn69h6s8.TEXT);
  var isDocument = isType$1($_7n266gymjn69h6s8.DOCUMENT);
  var $_3h5eqmyljn69h6s6 = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_3h5eqmyljn69h6s6.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_691giyytjn69h6ud = { toArray: toArray };
  ...
  var $_314nbhywjn69h6v2 = { getOrDie: getOrDie };

  var node = function () {
    var f = $_314nbhywjn69h6v2.getOrDie('Node');
    return f;
  };
  ...
  var $_7wyz2pyvjn69h6v2 = {
    documentPositionPreceding: documentPositionPreceding,
    documentPositionContainedBy: documentPositionContainedBy
  };

  var ELEMENT = $_7n266gymjn69h6s8.ELEMENT;
  var DOCUMENT = $_7n266gymjn69h6s8.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_7wyz2pyvjn69h6v2.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_bc3j7by4jn69h6no.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_bvdidiyujn69h6ug = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_facyuayzjn69h6vi.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_bvdidiyujn69h6ug.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_bvdidiyujn69h6ug.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_691giyytjn69h6ud.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_691giyytjn69h6ud.toArray(element, nextSibling);
  };
  ...
  var before = function (marker, element) {
    var parent = $_288vghyojn69h6sj.parent(marker);
    parent.each(function (v) {
      v.dom().insertBefore(element.dom(), marker.dom());
    });
  };
  var after = function (marker, element) {
    var sibling = $_288vghyojn69h6sj.nextSibling(marker);
  ...
  var prepend = function (parent, element) {
    var firstChild = $_288vghyojn69h6sj.firstChild(parent);
  ...
  var appendAt = function (parent, element, index) {
    $_288vghyojn69h6sj.child(parent, index).fold(function () {
      append(parent, element);
    }, function (v) {
      before(v, element);
    });
  ...
  var before$1 = function (marker, elements) {
    each$1(elements, function (x) {
      $_4lsz7aynjn69h6sf.before(marker, x);
    });
  };
  var after$1 = function (marker, elements) {
    each$1(elements, function (x, i) {
      var e = i === 0 ? marker : elements[i - 1];
      $_4lsz7aynjn69h6sf.after(e, x);
    });
  };
  var prepend$1 = function (parent, elements) {
    each$1(elements.slice().reverse(), function (x) {
      $_4lsz7aynjn69h6sf.prepend(parent, x);
    });
  };
  var append$1 = function (parent, elements) {
    each$1(elements, function (x) {
      $_4lsz7aynjn69h6sf.append(parent, x);
    });
  };
  var $_cdlb12z1jn69h6vx = {
    before: before$1,
    after: after$1,
    prepend: prepend$1,
    append: append$1
  ...
  var empty = function (element) {
    ...
    each$1($_288vghyojn69h6sj.children(element), function (rogue) {
      remove(rogue);
    });
  };
  ...
  var unwrap = function (wrapper) {
    var children = $_288vghyojn69h6sj.children(wrapper);
    if (children.length > 0)
      $_cdlb12z1jn69h6vx.before(wrapper, children);
    remove(wrapper);
  };
  var $_1fffmzz0jn69h6vi = {
    empty: empty,
    remove: remove,
    unwrap: unwrap
  };
  ...
  var attach = function (parent, child) {
    attachWith(parent, child, $_4lsz7aynjn69h6sf.append);
  };
  var attachWith = function (parent, child, insertion) {
    parent.getSystem().addToWorld(child);
    insertion(parent.element(), child.element());
    if ($_26b9v2yjjn69h6ra.inBody(parent.element())) {
      fireAttaching(child);
    }
  ...
  var doDetach = function (component) {
    ...
    $_1fffmzz0jn69h6vi.remove(component.element());
    component.getSystem().removeFromWorld(component);
  };
  var detach = function (component) {
    var parent = $_288vghyojn69h6sj.parent(component.element()).bind(function (p) {
  ...
  var detachChildren = function (component) {
    ...
    $_1fffmzz0jn69h6vi.empty(component.element());
    component.syncComponents();
  };
  var attachSystem = function (element, guiSystem) {
    $_4lsz7aynjn69h6sf.append(element, guiSystem.element());
    var children = $_288vghyojn69h6sj.children(guiSystem.element());
  ...
  var json = function () {
    return $_314nbhywjn69h6v2.getOrDie('JSON');
  };
  ...
  var $_6dftsyzijn69h70a = {
    parse: parse,
    stringify: stringify
  };

  var formatObj = function (input) {
    return isObject(input) && keys(input).length > 100 ? ' removed due to size' : $_6dftsyzijn69h70a.stringify(input, null, 2);
  };
  ...
  var isSource = function (component, simulatedEvent) {
    return $_bvdidiyujn69h6ug.eq(component.element(), simulatedEvent.event().target());
  };

  var nu$4 = function (parts) {
    if (!hasKey$1(parts, 'can') && !hasKey$1(parts, 'abort') && !hasKey$1(parts, 'run')) {
      throw new Error('EventHandler defined by: ' + $_6dftsyzijn69h70a.stringify(parts, null, 2) + ' does not have can, abort, or run!');
    }
  ...
  var defToStr = function (defn) {
    ...
    return $_6dftsyzijn69h70a.stringify(raw, null, 2);
  };
  var defToRaw = function (defn) {
    return {
      ...
      defChildren: defn.defChildren().fold(function () {
        ...
        return $_6dftsyzijn69h70a.stringify(d, null, 2);
      }),
  ...
  var transfer = function (source, destination, attrs) {
    if (!$_3h5eqmyljn69h6s6.isElement(source) || !$_3h5eqmyljn69h6s6.isElement(destination))
      return;
    each$1(attrs, function (attr) {
      transferOne(source, destination, attr);
    });
  };
  var $_68237pzxjn69h76e = {
    clone: clone,
    set: set,
    setAll: setAll,
    get: get$1,
  ...
  var read$1 = function (element, attr) {
    var value = $_68237pzxjn69h76e.get(element, attr);
    return value === undefined || value === '' ? [] : value.split(' ');
  };
  var add = function (element, attr, id) {
    var old = read$1(element, attr);
    var nu = old.concat([id]);
    $_68237pzxjn69h76e.set(element, attr, nu.join(' '));
    return true;
  };
  var remove$2 = function (element, attr, id) {
    ...
    if (nu.length > 0)
      ...
      $_68237pzxjn69h76e.remove(element, attr);
    return false;
  };
  var $_98tsrzzzjn69h76n = {
    read: read$1,
    add: add,
    remove: remove$2
  };
  ...
  var get$2 = function (element) {
    return $_98tsrzzzjn69h76n.read(element, 'class');
  };
  var add$1 = function (element, clazz) {
    return $_98tsrzzzjn69h76n.add(element, 'class', clazz);
  };
  var remove$3 = function (element, clazz) {
    return $_98tsrzzzjn69h76n.remove(element, 'class', clazz);
  };
  ...
  var add$2 = function (element, clazz) {
    if ($_dyhcsxzyjn69h76n.supports(element))
      element.dom().classList.add(clazz);
    else
      $_dyhcsxzyjn69h76n.add(element, clazz);
  };
  var cleanClass = function (element) {
    var classList = $_dyhcsxzyjn69h76n.supports(element) ? element.dom().classList : $_dyhcsxzyjn69h76n.get(element);
    if (classList.length === 0) {
      $_68237pzxjn69h76e.remove(element, 'class');
    }
  };
  var remove$4 = function (element, clazz) {
    if ($_dyhcsxzyjn69h76n.supports(element)) {
      ...
      $_dyhcsxzyjn69h76n.remove(element, clazz);
    cleanClass(element);
  };
  var toggle$1 = function (element, clazz) {
    return $_dyhcsxzyjn69h76n.supports(element) ? element.dom().classList.toggle(clazz) : $_dyhcsxzyjn69h76n.toggle(element, clazz);
  };
  var toggler = function (element, clazz) {
    var hasClasslist = $_dyhcsxzyjn69h76n.supports(element);
    var classList = element.dom().classList;
    var off = function () {
      if (hasClasslist)
        classList.remove(clazz);
  ...
  var has$2 = function (element, clazz) {
    return $_dyhcsxzyjn69h76n.supports(element) && element.dom().classList.contains(clazz);
  };
  var $_f5i2mxzvjn69h769 = {
    add: add$2,
    remove: remove$4,
    toggle: toggle$1,
    toggler: toggler,
  ...
  var swap = function (element, addCls, removeCls) {
    $_f5i2mxzvjn69h769.remove(element, removeCls);
    $_f5i2mxzvjn69h769.add(element, addCls);
  };
  ...
  var clear = function (component, swapConfig, swapState) {
    $_f5i2mxzvjn69h769.remove(component.element(), swapConfig.alpha());
    $_f5i2mxzvjn69h769.remove(component.element(), swapConfig.omega());
  };
  var isAlpha = function (component, swapConfig, swapState) {
    return $_f5i2mxzvjn69h769.has(component.element(), swapConfig.alpha());
  };
  var isOmega = function (component, swapConfig, swapState) {
    return $_f5i2mxzvjn69h769.has(component.element(), swapConfig.omega());
  };
  ...
  var first$1 = function (predicate) {
    return descendant($_26b9v2yjjn69h6ra.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_bvdidiyujn69h6ug.eq(scope, x) && predicate(x);
    });
  };
  ...
  var any$1 = function (predicate) {
    return $_ctt4rn104jn69h77u.first(predicate).isSome();
  };
  var ancestor$1 = function (scope, predicate, isRoot) {
    return $_ctt4rn104jn69h77u.ancestor(scope, predicate, isRoot).isSome();
  };
  var closest$1 = function (scope, predicate, isRoot) {
    return $_ctt4rn104jn69h77u.closest(scope, predicate, isRoot).isSome();
  };
  var sibling$1 = function (scope, predicate) {
    return $_ctt4rn104jn69h77u.sibling(scope, predicate).isSome();
  };
  var child$2 = function (scope, predicate) {
    return $_ctt4rn104jn69h77u.child(scope, predicate).isSome();
  };
  var descendant$1 = function (scope, predicate) {
    return $_ctt4rn104jn69h77u.descendant(scope, predicate).isSome();
  };
  var $_eajh42103jn69h77s = {
    any: any$1,
    ancestor: ancestor$1,
    closest: closest$1,
    sibling: sibling$1,
  ...
  var hasFocus = function (element) {
    var doc = $_288vghyojn69h6sj.owner(element).dom();
  ...
  var focusInside = function (element) {
    var doc = $_288vghyojn69h6sj.owner(element);
    var inside = active(doc).filter(function (a) {
      return $_eajh42103jn69h77s.closest(a, curry($_bvdidiyujn69h6ug.eq, element));
    });
  ...
  var search = function (element) {
    return active($_288vghyojn69h6sj.owner(element)).filter(function (e) {
      return element.dom().contains(e.dom());
    });
  };
  var $_cu8ag3102jn69h773 = {
    hasFocus: hasFocus,
    focus: focus$2,
    blur: blur$$1,
    active: active,
  ...
  var $_cxcqqx108jn69h78i = { openLink: openLink };
  ...
  var fromHtml$1 = function (html, scope) {
    ...
    var div = doc.createElement('div');
    div.innerHTML = html;
    return $_288vghyojn69h6sj.children(Element$$1.fromDom(div));
  };
  ...
  var set$1 = function (element, content) {
    var owner = $_288vghyojn69h6sj.owner(element);
    var docDom = owner.dom();
    var fragment = Element$$1.fromDom(docDom.createDocumentFragment());
    var contentElements = $_ueen310hjn69h7ag.fromHtml(content, docDom);
    $_cdlb12z1jn69h6vx.append(fragment, contentElements);
    $_1fffmzz0jn69h6vi.empty(element);
    $_4lsz7aynjn69h6sf.append(element, fragment);
  };
  var getOuter = function (element) {
    var container = Element$$1.fromTag('div');
    var clone = Element$$1.fromDom(element.dom().cloneNode(true));
    $_4lsz7aynjn69h6sf.append(container, clone);
    return get$3(container);
  };
  var $_8gah1t10gjn69h7ag = {
    get: get$3,
    set: set$1,
    getOuter: getOuter
  };
  ...
  var shallowAs = function (original, tag) {
    ...
    var attributes = $_68237pzxjn69h76e.clone(original);
    $_68237pzxjn69h76e.setAll(nu, attributes);
    return nu;
  };
  var copy = function (original, tag) {
    var nu = shallowAs(original, tag);
    var cloneChildren = $_288vghyojn69h6sj.children(deep$1(original));
    $_cdlb12z1jn69h6vx.append(nu, cloneChildren);
    return nu;
  };
  var mutate = function (original, tag) {
    var nu = shallowAs(original, tag);
    $_4lsz7aynjn69h6sf.before(original, nu);
    var children = $_288vghyojn69h6sj.children(original);
    $_cdlb12z1jn69h6vx.append(nu, children);
    $_1fffmzz0jn69h6vi.remove(original);
    return nu;
  };
  var $_5984l010ijn69h7ag = {
    shallow: shallow$1,
    shallowAs: shallowAs,
    deep: deep$1,
    copy: copy,
  ...
  var getHtml = function (element) {
    var clone = $_5984l010ijn69h7ag.shallow(element);
    return $_8gah1t10gjn69h7ag.getOuter(clone);
  };
  ...
  var toggle$2 = function (component, toggleConfig, toggleState) {
    $_f5i2mxzvjn69h769.toggle(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var on = function (component, toggleConfig, toggleState) {
    $_f5i2mxzvjn69h769.add(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var off = function (component, toggleConfig, toggleState) {
    $_f5i2mxzvjn69h769.remove(component.element(), toggleConfig.toggleClass());
    updateAriaState(component, toggleConfig);
  };
  var isOn = function (component, toggleConfig) {
    return $_f5i2mxzvjn69h769.has(component.element(), toggleConfig.toggleClass());
  };
  ...
  var updatePressed = function (component, ariaInfo, status) {
    $_68237pzxjn69h76e.set(component.element(), 'aria-pressed', status);
    if (ariaInfo.syncWithExpanded()) {
      updateExpanded(component, ariaInfo, status);
    }
  };
  var updateSelected = function (component, ariaInfo, status) {
    $_68237pzxjn69h76e.set(component.element(), 'aria-selected', status);
  };
  var updateChecked = function (component, ariaInfo, status) {
    $_68237pzxjn69h76e.set(component.element(), 'aria-checked', status);
  };
  var updateExpanded = function (component, ariaInfo, status) {
    $_68237pzxjn69h76e.set(component.element(), 'aria-expanded', status);
  };
  ...
  var format = function (command, update) {
    return Receiving.config({
      channels: wrap$2($_csmiie10ajn69h78i.formatChanged(), {
  ...
  var orientation = function (onReceive) {
    return Receiving.config({ channels: wrap$2($_csmiie10ajn69h78i.orientationChanged(), { onReceive: onReceive }) });
  };
  ...
  var events$2 = function (optAction) {
    ...
    var pointerEvents = $_bc3j7by4jn69h6no.detect().deviceType.isTouch() ? [run(tap(), onClick)] : [
      run(click(), onClick),
  ...
  var focus$3 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_cu8ag3102jn69h773.focus(component.element());
      focusConfig.onFocus()(component);
    }
  };
  var blur$1 = function (component, focusConfig) {
    if (!focusConfig.ignore()) {
      $_cu8ag3102jn69h773.blur(component.element());
    }
  };
  var isFocused = function (component) {
    return $_cu8ag3102jn69h773.hasFocus(component.element());
  };
  ...
  var $_8z678q118jn69h7kc = { isSupported: isSupported };
  ...
  var internalSet = function (dom, property, value) {
    ...
    if ($_8z678q118jn69h7kc.isSupported(dom))
  ...
  var get$4 = function (element, property) {
    ...
    var v = r === '' && !$_26b9v2yjjn69h6ra.inBody(element) ? getUnsafeProperty(dom, property) : r;
    return v === null ? undefined : v;
  };
  var getUnsafeProperty = function (dom, property) {
    return $_8z678q118jn69h7kc.isSupported(dom) ? dom.style.getPropertyValue(property) : '';
  };
  ...
  var remove$5 = function (element, property) {
    ...
    if ($_68237pzxjn69h76e.has(element, 'style') && trim($_68237pzxjn69h76e.get(element, 'style')) === '') {
      $_68237pzxjn69h76e.remove(element, 'style');
    }
  };
  var preserve = function (element, f) {
    var oldStyles = $_68237pzxjn69h76e.get(element, 'style');
    var result = f(element);
    var restore = oldStyles === undefined ? $_68237pzxjn69h76e.remove : $_68237pzxjn69h76e.set;
  ...
  var copy$1 = function (source, target) {
    ...
    if ($_8z678q118jn69h7kc.isSupported(sourceDom) && $_8z678q118jn69h7kc.isSupported(targetDom)) {
  ...
  function Dimension (name, getOffset) {
    ...
    var get = function (element) {
      ...
      if (r <= 0 || r === null) {
        var css = $_exugep117jn69h7jh.get(element, name);
    ...
    var aggregate = function (element, properties) {
      return foldl(properties, function (acc, property) {
        var val = $_exugep117jn69h7jh.get(element, property);
  ...
  var api = Dimension('height', function (element) {
    var dom = element.dom();
    return $_26b9v2yjjn69h6ra.inBody(element) ? dom.getBoundingClientRect().height : dom.offsetHeight;
  });
  ...
  var setMax = function (element, value) {
    ...
    $_exugep117jn69h7jh.set(element, 'max-height', absMax + 'px');
  };
  var $_bmsr1a116jn69h7je = {
    set: set$3,
    get: get$5,
    getOuter: getOuter$1,
    setMax: setMax
  ...
  var all$2 = function (predicate) {
    return descendants($_26b9v2yjjn69h6ra.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_288vghyojn69h6sj.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_288vghyojn69h6sj.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_288vghyojn69h6sj.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each$1($_288vghyojn69h6sj.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$3 = function (selector) {
    return $_facyuayzjn69h6vi.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_8rhsii11bjn69h7lc.ancestors(scope, function (e) {
      return $_facyuayzjn69h6vi.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_8rhsii11bjn69h7lc.siblings(scope, function (e) {
      return $_facyuayzjn69h6vi.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_8rhsii11bjn69h7lc.children(scope, function (e) {
      return $_facyuayzjn69h6vi.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_facyuayzjn69h6vi.all(selector, scope);
  };
  var $_2km9pz11ajn69h7ky = {
    all: all$3,
  ...
  var first$2 = function (selector) {
    return $_facyuayzjn69h6vi.one(selector);
  };
  var ancestor$2 = function (scope, selector, isRoot) {
    return $_ctt4rn104jn69h77u.ancestor(scope, function (e) {
      return $_facyuayzjn69h6vi.is(e, selector);
    }, isRoot);
  };
  var sibling$2 = function (scope, selector) {
    return $_ctt4rn104jn69h77u.sibling(scope, function (e) {
      return $_facyuayzjn69h6vi.is(e, selector);
    });
  };
  var child$3 = function (scope, selector) {
    return $_ctt4rn104jn69h77u.child(scope, function (e) {
      return $_facyuayzjn69h6vi.is(e, selector);
    });
  };
  var descendant$2 = function (scope, selector) {
    return $_facyuayzjn69h6vi.one(selector, scope);
  };
  var closest$2 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_facyuayzjn69h6vi.is, ancestor$2, scope, selector, isRoot);
  };
  var $_9ipd3211cjn69h7ls = {
    first: first$2,
    ancestor: ancestor$2,
    sibling: sibling$2,
    child: child$3,
  ...
  var dehighlightAll = function (component, hConfig, hState) {
    var highlighted = $_2km9pz11ajn69h7ky.descendants(component.element(), '.' + hConfig.highlightClass());
    each$1(highlighted, function (h) {
      $_f5i2mxzvjn69h769.remove(h, hConfig.highlightClass());
  ...
  var dehighlight = function (component, hConfig, hState, target) {
    ...
    $_f5i2mxzvjn69h769.remove(target.element(), hConfig.highlightClass());
    if (wasHighlighted) {
      hConfig.onDehighlight()(component, target);
    }
  };
  var highlight = function (component, hConfig, hState, target) {
    ...
    $_f5i2mxzvjn69h769.add(target.element(), hConfig.highlightClass());
    if (!wasHighlighted) {
  ...
  var highlightBy = function (component, hConfig, hState, predicate) {
    var items = $_2km9pz11ajn69h7ky.descendants(component.element(), '.' + hConfig.itemClass());
  ...
  var isHighlighted = function (component, hConfig, hState, queryTarget) {
    return $_f5i2mxzvjn69h769.has(queryTarget.element(), hConfig.highlightClass());
  };
  var getHighlighted = function (component, hConfig, hState) {
    return $_9ipd3211cjn69h7ls.descendant(component.element(), '.' + hConfig.highlightClass()).bind(function (e) {
  ...
  var getFirst = function (component, hConfig, hState) {
    return $_9ipd3211cjn69h7ls.descendant(component.element(), '.' + hConfig.itemClass()).bind(function (e) {
      return component.getSystem().getByDom(e).toOption();
    });
  };
  ...
  var getDelta = function (component, hConfig, hState, delta) {
    ...
    var current = findIndex(items, function (item) {
      return $_f5i2mxzvjn69h769.has(item, hConfig.highlightClass());
    });
  ...
  var dom = function () {
    var get = function (component) {
      return $_cu8ag3102jn69h773.search(component.element());
    };
  ...
  var create$2 = function (cyclicField) {
    ...
    var isVisible = function (tabbingConfig, element) {
      var target = tabbingConfig.visibilitySelector().bind(function (sel) {
        return $_9ipd3211cjn69h7ls.closest(element, sel);
      }).getOr(element);
      return $_bmsr1a116jn69h7je.get(target) > 0;
    };
    var findInitial = function (component, tabbingConfig) {
      var tabstops = $_2km9pz11ajn69h7ky.descendants(component.element(), tabbingConfig.selector());
    ...
    var findCurrent = function (component, tabbingConfig) {
      return tabbingConfig.focusManager().get(component).bind(function (elem) {
        return $_9ipd3211cjn69h7ls.closest(elem, tabbingConfig.selector());
      });
    };
    ...
    var go = function (component, simulatedEvent, tabbingConfig, cycle) {
      ...
      return findCurrent(component, tabbingConfig).bind(function (tabstop) {
        var optStopIndex = findIndex(tabstops, curry($_bvdidiyujn69h6ug.eq, tabstop));
  ...
  var inside = function (target) {
    return $_3h5eqmyljn69h6s6.name(target) === 'input' && $_68237pzxjn69h76e.get(target, 'type') !== 'radio' || $_3h5eqmyljn69h6s6.name(target) === 'textarea';
  };
  ...
  var getDirection = function (element) {
    return $_exugep117jn69h7jh.get(element, 'direction') === 'rtl' ? 'rtl' : 'ltr';
  };
  var $_5z9tsf11ujn69h7v5 = {
  ...
  var west = function (moveLeft, moveRight) {
    var movement = $_5z9tsf11ujn69h7v5.onDirection(moveLeft, moveRight);
    return useH(movement);
  };
  var east = function (moveLeft, moveRight) {
    var movement = $_5z9tsf11ujn69h7v5.onDirection(moveRight, moveLeft);
    return useH(movement);
  };
  ...
  var visibilityToggler = function (element, property, hiddenValue, visibleValue) {
    var initial = $_exugep117jn69h7jh.get(element, property);
    if (initial === undefined)
      initial = '';
    var value = initial === hiddenValue ? visibleValue : hiddenValue;
    var off = curry($_exugep117jn69h7jh.set, element, property, initial);
    var on = curry($_exugep117jn69h7jh.set, element, property, value);
  ...
  var locateVisible = function (container, current, selector) {
    var filter$$1 = $_d75w9911wjn69h7wh.isVisible;
    return locateIn(container, current, selector, filter$$1);
  };
  var locateIn = function (container, current, selector, filter$$1) {
    var predicate = curry($_bvdidiyujn69h6ug.eq, current);
    var candidates = $_2km9pz11ajn69h7ky.descendants(container, selector);
    var visible = filter(candidates, $_d75w9911wjn69h7wh.isVisible);
    return locate(visible, predicate);
  };
  var findIndex$2 = function (elements, target) {
    return findIndex(elements, function (elem) {
      return $_bvdidiyujn69h6ug.eq(target, elem);
    });
  };
  ...
  var focusIn = function (component, gridConfig, gridState) {
    $_9ipd3211cjn69h7ls.descendant(component.element(), gridConfig.selector()).each(function (first) {
      gridConfig.focusManager().set(component, first);
    });
  };
  var findCurrent = function (component, gridConfig) {
    return gridConfig.focusManager().get(component).bind(function (elem) {
      return $_9ipd3211cjn69h7ls.closest(elem, gridConfig.selector());
    });
  };
  ...
  var findCurrent$1 = function (component, flowConfig) {
    return flowConfig.focusManager().get(component).bind(function (elem) {
      return $_9ipd3211cjn69h7ls.closest(elem, flowConfig.selector());
    });
  };
  ...
  var focusIn$1 = function (component, flowConfig) {
    flowConfig.getInitial()(component).or($_9ipd3211cjn69h7ls.descendant(component.element(), flowConfig.selector())).each(function (first) {
  ...
  var focusIn$2 = function (component, matrixConfig) {
    var focused = matrixConfig.previousSelector()(component).orThunk(function () {
      ...
      return $_9ipd3211cjn69h7ls.descendant(component.element(), selectors.cell());
    });
  ...
  var execute$4 = function (component, simulatedEvent, matrixConfig) {
    return $_cu8ag3102jn69h773.search(component.element()).bind(function (focused) {
      return matrixConfig.execute()(component, simulatedEvent, focused);
    });
  };
  var toMatrix = function (rows, matrixConfig) {
    return map$1(rows, function (row) {
      return $_2km9pz11ajn69h7ky.descendants(row, matrixConfig.selectors().cell());
    });
  };
  var doMove$2 = function (ifCycle, ifMove) {
    return function (element, focused, matrixConfig) {
      var move$$1 = matrixConfig.cycles() ? ifCycle : ifMove;
      return $_9ipd3211cjn69h7ls.closest(focused, matrixConfig.selectors().row()).bind(function (inRow) {
        var cellsInRow = $_2km9pz11ajn69h7ky.descendants(inRow, matrixConfig.selectors().cell());
        return findIndex$2(cellsInRow, focused).bind(function (colIndex) {
          var allRows = $_2km9pz11ajn69h7ky.descendants(element, matrixConfig.selectors().row());
  ...
  var focusIn$3 = function (component, menuConfig) {
    $_9ipd3211cjn69h7ls.descendant(component.element(), menuConfig.selector()).each(function (first) {
  ...
  var subPlaceholder = function (owner, detail, compSpec, placeholders) {
    ...
    return readOptFrom$1(placeholders, compSpec.name).fold(function () {
      throw new Error('Unknown placeholder component: ' + compSpec.name + '\nKnown: [' + keys(placeholders) + ']\nNamespace: ' + owner.getOr('none') + '\nSpec: ' + $_6dftsyzijn69h70a.stringify(compSpec, null, 2));
    }, function (newSpec) {
  ...
  var substitutePlaces = function (owner, detail, components, placeholders) {
    ...
    each(ps, function (p) {
      if (p.used() === false && p.required()) {
        throw new Error('Placeholder: ' + p.name() + ' was not found in components list\nNamespace: ' + owner.getOr('none') + '\nComponents: ' + $_6dftsyzijn69h70a.stringify(detail.components(), null, 2));
      }
    });
    return outcome;
  };
  ...
  var write = function (label, elem) {
    ...
    $_68237pzxjn69h76e.set(elem, idAttr$1, id);
    return id;
  };
  var writeOnly = function (elem, uid) {
    $_68237pzxjn69h76e.set(elem, idAttr$1, uid);
  };
  var read$2 = function (elem) {
    var id = $_3h5eqmyljn69h6s6.isElement(elem) ? $_68237pzxjn69h76e.get(elem, idAttr$1) : null;
  ...
  var fromHtml$2 = function (html) {
    ...
    var children = $_288vghyojn69h6sj.children(elem);
    var attrs = getAttrs(elem);
    var classes = getClasses(elem);
    var contents = children.length === 0 ? {} : { innerHtml: $_8gah1t10gjn69h7ag.get(elem) };
    return deepMerge({
      tag: $_3h5eqmyljn69h6s6.name(elem),
      classes: classes,
      attributes: attrs
    }, contents);
  };
  ...
  var dom$1 = function (rawHtml) {
    var html = supplant(rawHtml, { prefix: $_fhb67k10ujn69h7ft.prefix() });
  ...
  var getToggleBehaviours = function (command) {
    return derive$2([
      Toggling.config({
        toggleClass: $_fhb67k10ujn69h7ft.resolve('toolbar-button-selected'),
        toggleOnExecute: false,
        aria: { mode: 'pressed' }
      }),
      $_6mmxim10tjn69h7fm.format(command, function (button, status) {
  ...
  var isTouch = $_bc3j7by4jn69h6no.detect().deviceType.isTouch();
  ...
  var platform = $_bc3j7by4jn69h6no.detect();
  ...
  var isTouch$2 = $_bc3j7by4jn69h6no.detect().deviceType.isTouch();
  var SliderSchema = [
    strict$1('min'),
    strict$1('max'),
  ...
  var setMax$1 = function (element, value) {
    ...
    $_exugep117jn69h7jh.set(element, 'max-width', absMax + 'px');
  };
  var $_3l0w5b131jn69h8e6 = {
    set: set$4,
    get: get$7,
    getOuter: getOuter$2,
    setMax: setMax$1
  ...
  var isTouch$3 = $_bc3j7by4jn69h6no.detect().deviceType.isTouch();
  var sketch$1 = function (detail, components$$1, spec, externals) {
    ...
    var refresh = function (component) {
      ...
      var thumbRadius = $_3l0w5b131jn69h8e6.get(thumb.element()) / 2;
      $_exugep117jn69h7jh.set(thumb.element(), 'left', pos - thumbRadius + 'px');
    };
    var changeValue = function (component, newValue) {
      var oldValue = detail.value().get();
      var thumb = getThumb(component);
      if (oldValue !== newValue || $_exugep117jn69h7jh.getRaw(thumb.element(), 'left').isNone()) {
  ...
  var button = function (realm, clazz, makeItems) {
    return $_8pjtl410vjn69h7fw.forToolbar(clazz, function () {
      var items = makeItems();
  ...
  var makeSlider = function (spec$$1) {
    ...
    var onInit = function (slider, thumb, value) {
      ...
      $_exugep117jn69h7jh.set(thumb.element(), 'background-color', color);
    };
    ...
    return Slider.sketch({
      ...
      components: [
        ...
        Slider.parts().spectrum({
          ...
          behaviours: derive$2([Toggling.config({ toggleClass: $_fhb67k10ujn69h7ft.resolve('thumb-active') })])
        }),
      ...
      sliderBehaviours: derive$2([$_6mmxim10tjn69h7fm.orientation(Slider.refresh)])
    });
  };
  ...
  var sketch$3 = function (rawSpec) {
    ...
    return Slider.sketch({
      dom: {
        tag: 'div',
        classes: [
          $_fhb67k10ujn69h7ft.resolve('slider-' + spec$$1.category + '-size-container'),
          $_fhb67k10ujn69h7ft.resolve('slider'),
          $_fhb67k10ujn69h7ft.resolve('slider-size-container')
        ]
      },
      onChange: onChange,
      onDragStart: function (slider, thumb) {
  ...
  var $_3hpvj1134jn69h8em = { sketch: sketch$3 };
  ...
  var getRawOrComputed = function (isRoot, rawStart) {
    var optStart = $_3h5eqmyljn69h6s6.isElement(rawStart) ? Option.some(rawStart) : $_288vghyojn69h6sj.parent(rawStart);
    return optStart.map(function (start) {
      var inline = $_ctt4rn104jn69h77u.closest(start, function (elem) {
        return $_exugep117jn69h7jh.getRaw(elem, 'font-size').isSome();
      }, isRoot).bind(function (elem) {
        return $_exugep117jn69h7jh.getRaw(elem, 'font-size');
      });
      return inline.getOrThunk(function () {
        return $_exugep117jn69h7jh.get(start, 'font-size');
      });
    }).getOr('');
  };
  var getSize = function (editor) {
    ...
    var isRoot = function (e) {
      return $_bvdidiyujn69h6ug.eq(root, e);
    };
  ...
  var $_a4b6zf135jn69h8f2 = {
    candidates: constant(candidates),
    get: get$8,
    apply: apply$1
  };

  var sizes = $_a4b6zf135jn69h8f2.candidates();
  var makeSlider$1 = function (spec$$1) {
    return $_3hpvj1134jn69h8em.sketch({
  ...
  var sketch$4 = function (realm, editor) {
    var spec$$1 = {
      onChange: function (value) {
        $_a4b6zf135jn69h8f2.apply(editor, value);
      },
      getInitialValue: function () {
        return $_a4b6zf135jn69h8f2.get(editor);
      }
    };
  ...
  function Blob (parts, properties) {
    var f = $_314nbhywjn69h6v2.getOrDie('Blob');
    return new f(parts, properties);
  }

  function FileReader () {
    var f = $_314nbhywjn69h6v2.getOrDie('FileReader');
    return new f();
  }

  function Uint8Array (arr) {
    var f = $_314nbhywjn69h6v2.getOrDie('Uint8Array');
    return new f(arr);
  }

  var requestAnimationFrame = function (callback) {
    var f = $_314nbhywjn69h6v2.getOrDie('requestAnimationFrame');
    f(callback);
  };
  var atob = function (base64) {
    var f = $_314nbhywjn69h6v2.getOrDie('atob');
    return f(base64);
  };
  var $_gg325413gjn69h8is = {
    atob: atob,
  ...
  function dataUriToBlobSync(uri) {
    ...
    var base64 = data[1];
    var sliceSize = 1024;
    var byteCharacters = $_gg325413gjn69h8is.atob(base64);
  ...
  function blobToCanvas(blob) {
    return blobToImage(blob).then(function (image) {
      ...
      var context, canvas;
      canvas = $_4wy4h613ajn69h8im.create($_9vhu9h13bjn69h8ip.getWidth(image), $_9vhu9h13bjn69h8ip.getHeight(image));
      context = $_4wy4h613ajn69h8im.get2dContext(canvas);
  ...
  var blobToImage$1 = function (image) {
    return $_dzer1v139jn69h8hf.blobToImage(image);
  };
  var imageToBlob$1 = function (blob) {
    return $_dzer1v139jn69h8hf.imageToBlob(blob);
  };
  var blobToDataUri$1 = function (blob) {
    return $_dzer1v139jn69h8hf.blobToDataUri(blob);
  };
  var blobToBase64$1 = function (blob) {
    return $_dzer1v139jn69h8hf.blobToBase64(blob);
  };
  var dataUriToBlobSync$1 = function (uri) {
    return $_dzer1v139jn69h8hf.dataUriToBlobSync(uri);
  };
  var uriToBlob$1 = function (uri) {
    return Option.from($_dzer1v139jn69h8hf.uriToBlob(uri));
  };
  var $_5xi5jw138jn69h8h6 = {
  ...
  var addImage = function (editor, blob) {
    $_5xi5jw138jn69h8h6.blobToBase64(blob).then(function (base64) {
      editor.undoManager.transact(function () {
  ...
  var fromLink = function (link) {
    var text = $_zw8yv13jjn69h8k3.get(link);
    var url = $_68237pzxjn69h76e.get(link, 'href');
    var title = $_68237pzxjn69h76e.get(link, 'title');
    var target = $_68237pzxjn69h76e.get(link, 'target');
    return {
  ...
  var wasSimple = function (link) {
    var prevHref = $_68237pzxjn69h76e.get(link, 'href');
    var prevText = $_zw8yv13jjn69h8k3.get(link);
  ...
  var applyInfo = function (editor, info) {
    info.url.filter(isNotEmpty).fold(function () {
      ...
      activeLink.fold(function () {
        ...
        $_68237pzxjn69h76e.setAll(link, attrs);
        text.each(function (newText) {
          $_zw8yv13jjn69h8k3.set(link, newText);
        });
      });
    });
  };
  var query = function (editor) {
    ...
    return $_9ipd3211cjn69h7ls.closest(start, 'a');
  };
  var $_4lb0rr13ijn69h8j8 = {
    getInfo: getInfo,
    applyInfo: applyInfo,
    query: query
  };

  var platform$1 = $_bc3j7by4jn69h6no.detect();
  ...
  var $_b71m0713kjn69h8k3 = { forAndroid: forAndroid };
  ...
  var focusBehaviours = function (detail) {
    return derive$2([Focusing.config({
        onFocus: detail.selectOnFocus() === false ? noop : function (component) {
          ...
          var value = $_fqox9k13ujn69h8pm.get(input);
    ...
    return deepMerge(derive$2([Representing.config({
        store: {
          ...
          getValue: function (input) {
            return $_fqox9k13ujn69h8pm.get(input.element());
          },
          setValue: function (input, data) {
            var current = $_fqox9k13ujn69h8pm.get(input.element());
            if (current !== data) {
              $_fqox9k13ujn69h8pm.set(input.element(), data);
            }
          }
        },
    ...
    return {
      ...
      spec: Container.sketch({
        ...
        containerBehaviours: derive$2([
          Toggling.config({ toggleClass: $_fhb67k10ujn69h7ft.resolve('input-container-empty') }),
          Composing.config({
            find: function (comp) {
  ...
  var hasNative = function (component) {
    return contains(nativeDisabled, $_3h5eqmyljn69h6s6.name(component.element()));
  };
  var nativeIsDisabled = function (component) {
    return $_68237pzxjn69h76e.has(component.element(), 'disabled');
  };
  var nativeDisable = function (component) {
    $_68237pzxjn69h76e.set(component.element(), 'disabled', 'disabled');
  };
  var nativeEnable = function (component) {
    $_68237pzxjn69h76e.remove(component.element(), 'disabled');
  };
  var ariaIsDisabled = function (component) {
    return $_68237pzxjn69h76e.get(component.element(), 'aria-disabled') === 'true';
  };
  var ariaDisable = function (component) {
    $_68237pzxjn69h76e.set(component.element(), 'aria-disabled', 'true');
  };
  var ariaEnable = function (component) {
    $_68237pzxjn69h76e.set(component.element(), 'aria-disabled', 'false');
  };
  var disable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_f5i2mxzvjn69h769.add(component.element(), disableClass);
    });
  ...
  var enable = function (component, disableConfig, disableState) {
    disableConfig.disableClass().each(function (disableClass) {
      $_f5i2mxzvjn69h769.remove(component.element(), disableClass);
    });
  ...
  var sketch$7 = function (rawSpec) {
    ...
    var navigationButton = function (direction, directionName, enabled) {
      return Button.sketch({
        ...
        buttonBehaviours: derive$2([Disabling.config({
            disableClass: $_fhb67k10ujn69h7ft.resolve('toolbar-navigation-disabled'),
            disabled: !enabled
          })])
      });
    };
    var reposition = function (dialog, message) {
      $_9ipd3211cjn69h7ls.descendant(dialog.element(), '.' + $_fhb67k10ujn69h7ft.resolve('serialised-dialog-chain')).each(function (parent) {
        $_exugep117jn69h7jh.set(parent, 'left', -spec$$1.state.currentScreen.get() * message.width + 'px');
      });
    };
    var navigate = function (dialog, direction) {
      var screens = $_2km9pz11ajn69h7ky.descendants(dialog.element(), '.' + $_fhb67k10ujn69h7ft.resolve('serialised-dialog-screen'));
      $_9ipd3211cjn69h7ls.descendant(dialog.element(), '.' + $_fhb67k10ujn69h7ft.resolve('serialised-dialog-chain')).each(function (parent) {
        if (spec$$1.state.currentScreen.get() + direction >= 0 && spec$$1.state.currentScreen.get() + direction < screens.length) {
          $_exugep117jn69h7jh.getRaw(parent, 'left').each(function (left) {
            var currentLeft = parseInt(left, 10);
            var w = $_3l0w5b131jn69h8e6.get(screens[0]);
            $_exugep117jn69h7jh.set(parent, 'left', currentLeft - direction * w + 'px');
          });
    ...
    var focusInput = function (dialog) {
      var inputs = $_2km9pz11ajn69h7ky.descendants(dialog.element(), 'input');
    ...
    var memForm = record(Form.sketch(function (parts) {
      return {
        ...
        formBehaviours: derive$2([
          $_6mmxim10tjn69h7fm.orientation(function (dialog, message) {
    ...
    var memDots = record({
      ...
      behaviours: derive$2([Highlighting.config({
          highlightClass: $_fhb67k10ujn69h7ft.resolve('dot-active'),
          itemClass: $_fhb67k10ujn69h7ft.resolve('dot-item')
        })]),
      ...
      behaviours: derive$2([
        ...
        config(wrapperAdhocEvents, [
          run(touchstart(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.set($_3pgxb8145jn69h8ub.init(event.touches[0].clientX));
          }),
          run(touchmove(), function (wrapper, simulatedEvent) {
            var event = simulatedEvent.event();
            spec$$1.state.dialogSwipeState.on(function (state) {
              simulatedEvent.event().prevent();
              spec$$1.state.dialogSwipeState.set($_3pgxb8145jn69h8ub.move(state, event.raw().touches[0].clientX));
            });
          }),
          run(touchend(), function (wrapper) {
            spec$$1.state.dialogSwipeState.on(function (state) {
              var dialog = memForm.get(wrapper);
              var direction = -1 * $_3pgxb8145jn69h8ub.complete(state);
              navigate(dialog, direction);
            });
          })
        ])
  ...
  var getGroups = cached(function (realm, editor) {
    return [{
        ...
        items: [sketch$7({
            ...
            getInitialValue: function () {
              return Option.some($_4lb0rr13ijn69h8j8.getInfo(editor));
            },
            onExecute: function (dialog) {
              var info = Representing.getValue(dialog);
              $_4lb0rr13ijn69h8j8.applyInfo(editor, info);
  ...
  var sketch$8 = function (realm, editor) {
    return $_8pjtl410vjn69h7fw.forToolbarStateAction(editor, 'link', 'link', function () {
      var groups = getGroups(realm, editor);
      realm.setContextToolbar(groups);
      $_b71m0713kjn69h8k3.forAndroid(editor, function () {
        realm.focusToolbar();
      });
      $_4lb0rr13ijn69h8j8.query(editor).each(function (link) {
  ...
  var isRecursive = function (component, originator, target) {
    return $_bvdidiyujn69h6ug.eq(originator, component.element()) && !$_bvdidiyujn69h6ug.eq(originator, target);
  };
  ...
  var generateFrom = function (spec, all) {
    ...
    var validated = asStruct('component.behaviours', objOf(schema), spec.behaviours).fold(function (errInfo) {
      throw new Error(formatError(errInfo) + '\nComplete spec:\n' + $_6dftsyzijn69h70a.stringify(spec, null, 2));
    }, function (v) {
      return v;
    });
    return {
  ...
  var onlyOne = function (chain, aspect) {
    if (chain.length > 1) {
      return Result.error('Multiple behaviours have tried to change DOM "' + aspect + '". The guilty behaviours are: ' + $_6dftsyzijn69h70a.stringify(map$1(chain, function (b) {
        return b.name();
  ...
  var duplicate = function (aspect, k, obj, behaviours) {
    return Result.error('Mulitple behaviours have tried to change the _' + k + '_ "' + aspect + '"' + '. The guilty behaviours are: ' + $_6dftsyzijn69h70a.stringify(bind(behaviours, function (b) {
  ...
  var sortKeys = function (label, keyName, array, order) {
    ...
    try {
      var sorted = sliced.sort(function (a, b) {
        ...
        if (aIndex === -1) {
          throw new Error('The ordering for ' + label + ' does not have an entry for ' + aKey + '.\nOrder specified: ' + $_6dftsyzijn69h70a.stringify(order, null, 2));
        }
        if (bIndex === -1) {
  ...
  var missingOrderError = function (eventName, tuples) {
    return Result.error(['The event (' + eventName + ') has more than one behaviour that listens to it.\nWhen this occurs, you must ' + 'specify an event ordering for the behaviours in your spec (e.g. [ "listing", "toggling" ]).\nThe behaviours that ' + 'can trigger it are: ' + $_6dftsyzijn69h70a.stringify(map$1(tuples, function (c) {
        return c.name();
      }), null, 2)]);
  };
  ...
  var add$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_f5i2mxzvjn69h769.add(element, x);
    });
  };
  var remove$6 = function (element, classes) {
    each$1(classes, function (x) {
      $_f5i2mxzvjn69h769.remove(element, x);
    });
  };
  var toggle$3 = function (element, classes) {
    each$1(classes, function (x) {
      $_f5i2mxzvjn69h769.toggle(element, x);
    });
  };
  var hasAll = function (element, classes) {
    return forall(classes, function (clazz) {
      return $_f5i2mxzvjn69h769.has(element, clazz);
    });
  };
  ...
  var get$11 = function (element) {
    return $_dyhcsxzyjn69h76n.supports(element) ? getNative(element) : $_dyhcsxzyjn69h76n.get(element);
  };
  var $_eoomzq14njn69h94y = {
    add: add$3,
    remove: remove$6,
    toggle: toggle$3,
    hasAll: hasAll,
  ...
  var renderToDom = function (definition) {
    ...
    $_68237pzxjn69h76e.setAll(subject, definition.attributes().getOr({}));
    $_eoomzq14njn69h94y.add(subject, definition.classes().getOr([]));
    $_exugep117jn69h7jh.setAll(subject, definition.styles().getOr({}));
    $_8gah1t10gjn69h7ag.set(subject, definition.innerHtml().getOr(''));
    var children = getChildren(definition);
    $_cdlb12z1jn69h6vx.append(subject, children);
    definition.value().each(function (value) {
      $_fqox9k13ujn69h8pm.set(subject, value);
    });
    return subject;
  };
  ...
  var build = function (spec) {
    ...
    var syncComponents = function () {
      var children = $_288vghyojn69h6sj.children(item);
    ...
    var config = function (behaviour) {
      ...
      var f = isFunction(b[behaviour.name()]) ? b[behaviour.name()] : function () {
        throw new Error('Could not find ' + behaviour.name() + ' in ' + $_6dftsyzijn69h70a.stringify(spec, null, 2));
      };
      return f();
    };
  ...
  var onHover = function (item) {
    if ($_cu8ag3102jn69h773.search(item.element()).isNone() || Focusing.isFocused(item)) {
  ...
  var preserve$2 = function (f, container) {
    var ownerDoc = $_288vghyojn69h6sj.owner(container);
    var refocus = $_cu8ag3102jn69h773.active(ownerDoc).bind(function (focused) {
      var hasFocus = function (elem) {
        return $_bvdidiyujn69h6ug.eq(focused, elem);
      };
      return hasFocus(container) ? Option.some(container) : $_ctt4rn104jn69h77u.descendant(container, hasFocus);
    });
    var result = f(container);
    refocus.each(function (oldFocus) {
      $_cu8ag3102jn69h773.active(ownerDoc).filter(function (newFocus) {
        return $_bvdidiyujn69h6ug.eq(newFocus, oldFocus);
      }).fold(function () {
        $_cu8ag3102jn69h773.focus(oldFocus);
      }, noop);
    });
    return result;
  };
  ...
  var append$2 = function (component, replaceConfig, replaceState, appendee) {
    insert(component, replaceConfig, $_4lsz7aynjn69h6sf.append, appendee);
  };
  var prepend$2 = function (component, replaceConfig, replaceState, prependee) {
    insert(component, replaceConfig, $_4lsz7aynjn69h6sf.prepend, prependee);
  };
  var remove$7 = function (component, replaceConfig, replaceState, removee) {
    var children = contents(component, replaceConfig);
    var foundChild = find$2(children, function (child) {
      return $_bvdidiyujn69h6ug.eq(removee.element(), child.element());
    });
  ...
  var make$3 = function (detail, rawUiSpec) {
    ...
    var updateMenuPath = function (container, state, path) {
      return Option.from(path[0]).bind(state.lookupMenu).map(function (activeMenu) {
        ...
        each$1(rest, function (r) {
          $_f5i2mxzvjn69h769.add(r.element(), detail.markers().backgroundMenu());
        });
        if (!$_26b9v2yjjn69h6ra.inBody(activeMenu.element())) {
          Replacing.append(container, premade$1(activeMenu));
        }
        $_eoomzq14njn69h94y.remove(activeMenu.element(), [detail.markers().backgroundMenu()]);
        setActiveMenu(container, activeMenu);
        var others = getMenus(state, state.otherMenus(path));
        each$1(others, function (o) {
          $_eoomzq14njn69h94y.remove(o.element(), [detail.markers().backgroundMenu()]);
          if (!detail.stayInDom()) {
    ...
    var keyOnItem = function (f) {
      return function (container, simulatedEvent) {
        return $_9ipd3211cjn69h7ls.closest(simulatedEvent.getSource(), '.' + detail.markers().item()).bind(function (target) {
  ...
  var disableTransition = function (comp, transConfig, transState) {
    getTransition(comp, transConfig, transState).each(function (routeTransition) {
      ...
      $_f5i2mxzvjn69h769.remove(comp.element(), t.transitionClass());
      $_68237pzxjn69h76e.remove(comp.element(), transConfig.destinationAttr());
    });
  };
  var getNewRoute = function (comp, transConfig, transState, destination) {
    return {
      start: constant($_68237pzxjn69h76e.get(comp.element(), transConfig.stateAttr())),
      destination: constant(destination)
    };
  };
  var getCurrentRoute = function (comp, transConfig, transState) {
    var el = comp.element();
    return $_68237pzxjn69h76e.has(el, transConfig.destinationAttr()) ? Option.some({
      start: constant($_68237pzxjn69h76e.get(comp.element(), transConfig.stateAttr())),
      destination: constant($_68237pzxjn69h76e.get(comp.element(), transConfig.destinationAttr()))
    }) : Option.none();
  };
  var jumpTo = function (comp, transConfig, transState, destination) {
    disableTransition(comp, transConfig, transState);
    if ($_68237pzxjn69h76e.has(comp.element(), transConfig.stateAttr()) && $_68237pzxjn69h76e.get(comp.element(), transConfig.stateAttr()) !== destination) {
      transConfig.onFinish()(comp, destination);
    }
    $_68237pzxjn69h76e.set(comp.element(), transConfig.stateAttr(), destination);
  };
  var fasttrack = function (comp, transConfig, transState, destination) {
    if ($_68237pzxjn69h76e.has(comp.element(), transConfig.destinationAttr())) {
      $_68237pzxjn69h76e.set(comp.element(), transConfig.stateAttr(), $_68237pzxjn69h76e.get(comp.element(), transConfig.destinationAttr()));
      $_68237pzxjn69h76e.remove(comp.element(), transConfig.destinationAttr());
    }
  };
  var progressTo = function (comp, transConfig, transState, destination) {
    ...
    getTransitionOf(comp, transConfig, transState, route).fold(function () {
      ...
      disableTransition(comp, transConfig, transState);
      var t = routeTransition.transition();
      $_f5i2mxzvjn69h769.add(comp.element(), t.transitionClass());
      $_68237pzxjn69h76e.set(comp.element(), transConfig.destinationAttr(), destination);
    });
  };
  var getState = function (comp, transConfig, transState) {
    var e = comp.element();
    return $_68237pzxjn69h76e.has(e, transConfig.stateAttr()) ? Option.some($_68237pzxjn69h76e.get(e, transConfig.stateAttr())) : Option.none();
  };
  ...
  var scrollable = $_fhb67k10ujn69h7ft.resolve('scrollable');
  var register = function (element) {
    $_f5i2mxzvjn69h769.add(element, scrollable);
  };
  var deregister = function (element) {
    $_f5i2mxzvjn69h769.remove(element, scrollable);
  };
  var $_oghq815ajn69h9dv = {
    register: register,
  ...
  var makeItem = function (value, text$$1, selected, preview, isMenu) {
    return {
      ...
      dom: {
        tag: 'div',
        classes: isMenu ? [$_fhb67k10ujn69h7ft.resolve('styles-item-is-menu')] : []
      },
      toggling: {
        toggleOnExecute: false,
        toggleClass: $_fhb67k10ujn69h7ft.resolve('format-matches'),
        selected: selected
      },
      itemBehaviours: derive$2(isMenu ? [] : [$_6mmxim10tjn69h7fm.format(value, function (comp, status) {
          var toggle = status ? Toggling.on : Toggling.off;
          toggle(comp);
        })]),
      components: [{
    ...
    return {
      ...
      components: [
        Button.sketch({
          dom: {
            tag: 'div',
            classes: [$_fhb67k10ujn69h7ft.resolve('styles-collapser')]
          },
          components: collapsable ? [
            {
              dom: {
                tag: 'span',
                classes: [$_fhb67k10ujn69h7ft.resolve('styles-collapse-icon')]
              }
            },
            text(value)
          ] : [text(value)],
        ...
        }),
        {
          dom: {
            tag: 'div',
            classes: [$_fhb67k10ujn69h7ft.resolve('styles-menu-items-container')]
          },
          components: [Menu.parts().items({})],
          behaviours: derive$2([config('adhoc-scrollable-menu', [
              runOnAttached(function (component, simulatedEvent) {
                $_exugep117jn69h7jh.set(component.element(), 'overflow-y', 'auto');
                $_exugep117jn69h7jh.set(component.element(), '-webkit-overflow-scrolling', 'touch');
                $_oghq815ajn69h9dv.register(component.element());
              }),
              runOnDetached(function (component) {
                $_exugep117jn69h7jh.remove(component.element(), 'overflow-y');
                $_exugep117jn69h7jh.remove(component.element(), '-webkit-overflow-scrolling');
                $_oghq815ajn69h9dv.deregister(component.element());
              })
            ])])
        }
      ],
  ...
  var sketch$9 = function (settings) {
    ...
    var memMenu = record(tieredMenu.sketch({
      dom: {
        tag: 'div',
        classes: [$_fhb67k10ujn69h7ft.resolve('styles-menu')]
      },
      components: [],
      fakeFocus: true,
      stayInDom: true,
      ...
      onOpenMenu: function (container, menu) {
        var w = $_3l0w5b131jn69h8e6.get(container.element());
        $_3l0w5b131jn69h8e6.set(menu.element(), w);
        Transitioning.jumpTo(menu, 'current');
      },
      onOpenSubmenu: function (container, item, submenu) {
        var w = $_3l0w5b131jn69h8e6.get(container.element());
        var menu = $_9ipd3211cjn69h7ls.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
        var menuComp = container.getSystem().getByDom(menu).getOrDie();
        $_3l0w5b131jn69h8e6.set(submenu.element(), w);
        Transitioning.progressTo(menuComp, 'before');
        Transitioning.jumpTo(submenu, 'after');
        Transitioning.progressTo(submenu, 'current');
      },
      onCollapseMenu: function (container, item, menu) {
        var submenu = $_9ipd3211cjn69h7ls.ancestor(item.element(), '[role="menu"]').getOrDie('hacky');
      ...
      data: dataset.tmenu,
      markers: {
        backgroundMenu: $_fhb67k10ujn69h7ft.resolve('styles-background-menu'),
        menu: $_fhb67k10ujn69h7ft.resolve('styles-menu'),
        selectedMenu: $_fhb67k10ujn69h7ft.resolve('styles-selected-menu'),
        item: $_fhb67k10ujn69h7ft.resolve('styles-item'),
        selectedItem: $_fhb67k10ujn69h7ft.resolve('styles-selected-item')
      }
    }));
    return memMenu.asSpec();
  };
  var $_frzlfn148jn69h8ur = { sketch: sketch$9 };
  ...
  var $_2om8q415bjn69h9e1 = { expand: expand };
  ...
  var prune = function (editor, formats) {
    ...
    return $_2om8q415bjn69h9e1.expand(prunedItems);
  };
  var ui = function (editor, formats, onDone) {
    var pruned = prune(editor, formats);
    return $_frzlfn148jn69h8ur.sketch({
      formats: pruned,
  ...
  var setup = function (realm, editor) {
    var commandSketch = function (name) {
      return function () {
        return $_8pjtl410vjn69h7fw.forToolbarCommand(editor, name);
      };
    };
    var stateCommandSketch = function (name) {
      return function () {
        return $_8pjtl410vjn69h7fw.forToolbarStateCommand(editor, name);
      };
    };
    var actionSketch = function (name, query, action) {
      return function () {
        return $_8pjtl410vjn69h7fw.forToolbarStateAction(editor, name, query, action);
      };
    };
    ...
    var forecolor = function () {
      return $_aqxtjh12ljn69h89b.sketch(realm, editor);
    };
    var styleFormats = $_4moyv146jn69h8ub.register(editor, editor.settings);
    var styleFormatsMenu = function () {
      return $_4moyv146jn69h8ub.ui(editor, styleFormats, function () {
        editor.fire('scrollIntoView');
      });
    };
    var styleselect = function () {
      return $_8pjtl410vjn69h7fw.forToolbar('style-formats', function (button) {
        ...
        Receiving.config({
          channels: wrapAll$1([
            $_6mmxim10tjn69h7fm.receive($_csmiie10ajn69h78i.orientationChanged(), Toggling.off),
            $_6mmxim10tjn69h7fm.receive($_csmiie10ajn69h78i.dropupDismissed(), Toggling.off)
          ])
        })
      ]));
    };
  ...
  var bind$2 = function (element, event, handler) {
    return $_61wm4r15ejn69h9ew.bind(element, event, filter$1, handler);
  };
  var capture$1 = function (element, event, handler) {
    return $_61wm4r15ejn69h9ew.capture(element, event, filter$1, handler);
  };
  var $_ct4oxc15djn69h9eq = {
    bind: bind$2,
    capture: capture$1
  };
  ...
  var getActualWidth = function (outerWindow) {
    var isIos = $_bc3j7by4jn69h6no.detect().os.isiOS();
  ...
  var onChange = function (outerWindow, listeners) {
    ...
    var orientationHandle = $_ct4oxc15djn69h9eq.bind(win, 'orientationchange', change);
  ...
  var monitor = function (settings) {
    ...
    var handleTouchend = function (event) {
      ...
      var isSame = function (data) {
        return $_bvdidiyujn69h6ug.eq(data.target(), event.target());
      };
  ...
  var monitor$1 = function (editorApi) {
    ...
    var onTouchend = function () {
      return $_ct4oxc15djn69h9eq.bind(editorApi.body(), 'touchend', function (evt) {
        tapEvent.fireIfReady(evt, 'touchend');
      });
    };
    var onTouchmove = function () {
      return $_ct4oxc15djn69h9eq.bind(editorApi.body(), 'touchmove', function (evt) {
  ...
  var $_95n8ru15jjn69h9h8 = { monitor: monitor$1 };

  var isAndroid6 = $_bc3j7by4jn69h6no.detect().os.version.major >= 6;
  var initEvents = function (editorApi, toolstrip, alloy) {
    var tapping = $_95n8ru15jjn69h9h8.monitor(editorApi);
    var outerDoc = $_288vghyojn69h6sj.owner(toolstrip);
    var isRanged = function (sel) {
      return !$_bvdidiyujn69h6ug.eq(sel.start(), sel.finish()) || sel.soffset() !== sel.foffset();
    };
    var hasRangeInUi = function () {
      return $_cu8ag3102jn69h773.active(outerDoc).filter(function (input) {
        return $_3h5eqmyljn69h6s6.name(input) === 'input';
    ...
    var listeners = [
      $_ct4oxc15djn69h9eq.bind(editorApi.body(), 'touchstart', function (evt) {
        editorApi.onTouchContent();
        tapping.fireTouchstart(evt);
      }),
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_ct4oxc15djn69h9eq.bind(toolstrip, 'touchstart', function (evt) {
        editorApi.onTouchToolstrip();
      }),
      editorApi.onToReading(function () {
        $_cu8ag3102jn69h773.blur(editorApi.body());
      }),
      ...
      $_ct4oxc15djn69h9eq.bind(Element$$1.fromDom(editorApi.win()), 'blur', function () {
        alloy.getByDom(toolstrip).each(Toggling.off);
      }),
      $_ct4oxc15djn69h9eq.bind(outerDoc, 'select', updateMargin),
      $_ct4oxc15djn69h9eq.bind(editorApi.doc(), 'selectionchange', updateMargin)
    ]);
    var destroy = function () {
  ...
  var $_gckgpj15ijn69h9g4 = { initEvents: initEvents };

  var safeParse = function (element, attribute) {
    var parsed = parseInt($_68237pzxjn69h76e.get(element, attribute), 10);
    return isNaN(parsed) ? 0 : parsed;
  };
  var $_chg5zh15njn69h9j3 = { safeParse: safeParse };
  ...
  var api$3 = NodeValue($_3h5eqmyljn69h6s6.isText, 'text');
  ...
  var getEnd = function (element) {
    return $_3h5eqmyljn69h6s6.name(element) === 'img' ? 1 : $_ezyiff15qjn69h9jx.getOption(element).fold(function () {
      return $_288vghyojn69h6sj.children(element).length;
    }, function (v) {
      return v.length;
    });
  };
  ...
  var isTextNodeWithCursorPosition = function (el) {
    return $_ezyiff15qjn69h9jx.getOption(el).filter(function (text) {
  ...
  var isCursorPosition = function (elem) {
    ...
    return hasCursorPosition || contains(elementsWithCursorPosition, $_3h5eqmyljn69h6s6.name(elem));
  };
  var $_cjr7py15pjn69h9js = {
    getEnd: getEnd,
    isEnd: isEnd,
    isStart: isStart,
  ...
  var getStart$1 = function (selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return $_gi3sbx15tjn69h9kh.getStart(startSitu);
      },
  ...
  var getWin = function (selection) {
    ...
    return $_288vghyojn69h6sj.defaultView(start);
  };
  var $_19sjbb15sjn69h9k9 = {
  ...
  var makeRange = function (start, soffset, finish, foffset) {
    var doc = $_288vghyojn69h6sj.owner(start);
  ...
  var after$2 = function (start, soffset, finish, foffset) {
    var r = makeRange(start, soffset, finish, foffset);
    var same = $_bvdidiyujn69h6ug.eq(start, finish) && soffset === foffset;
    return r.collapsed && !same;
  };
  var $_9moxqb15vjn69h9ky = {
    after: after$2,
  ...
  var $_b0ttme15wjn69h9kz = { fromElements: fromElements };
  ...
  var getRanges = function (win, selection) {
    return selection.match({
      ...
      relative: function (startSitu, finishSitu) {
        return {
          ltr: cached(function () {
            return $_8mc4ca15xjn69h9l5.relativeToNative(win, startSitu, finishSitu);
          }),
          rtl: cached(function () {
            return Option.some($_8mc4ca15xjn69h9l5.relativeToNative(win, finishSitu, startSitu));
          })
        };
      },
      exact: function (start, soffset, finish, foffset) {
        return {
          ltr: cached(function () {
            return $_8mc4ca15xjn69h9l5.exactToNative(win, start, soffset, finish, foffset);
          }),
          rtl: cached(function () {
            return Option.some($_8mc4ca15xjn69h9l5.exactToNative(win, finish, foffset, start, soffset));
          })
        };
      }
    });
  ...
  var locateOffset = function (doc, textnode, x, y, rect) {
    ...
    var length = $_ezyiff15qjn69h9jx.get(textnode).length;
    var offset = $_d4ois0161jn69h9mc.searchForPoint(rectForOffset, x, y, rect.right, length);
  ...
  var locate$1 = function (doc, node, x, y) {
    ...
    var foundRect = findMap(rects, function (rect) {
      return $_d4ois0161jn69h9mc.inRect(rect, x, y) ? Option.some(rect) : Option.none();
    });
    return foundRect.map(function (rect) {
      return locateOffset(doc, node, x, y, rect);
    });
  };
  var $_208wcb162jn69h9me = { locate: locate$1 };

  var searchInChildren = function (doc, node, x, y) {
    var r = doc.dom().createRange();
    var nodes = $_288vghyojn69h6sj.children(node);
    return findMap(nodes, function (n) {
      r.selectNode(n.dom());
      return $_d4ois0161jn69h9mc.inRect(r.getBoundingClientRect(), x, y) ? locateNode(doc, n, x, y) : Option.none();
    });
  };
  var locateNode = function (doc, node, x, y) {
    var locator = $_3h5eqmyljn69h6s6.isText(node) ? $_208wcb162jn69h9me.locate : searchInChildren;
  ...
  var $_ehq75v160jn69h9m0 = { locate: locate$2 };

  var first$3 = function (element) {
    return $_ctt4rn104jn69h77u.descendant(element, $_cjr7py15pjn69h9js.isCursorPosition);
  };
  var last$2 = function (element) {
    return descendantRtl(element, $_cjr7py15pjn69h9js.isCursorPosition);
  };
  var descendantRtl = function (scope, predicate) {
    var descend = function (element) {
      var children = $_288vghyojn69h6sj.children(element);
  ...
  var locateInElement = function (doc, node, x) {
    ...
    var f = collapseDirection === COLLAPSE_TO_LEFT ? $_6kydfw164jn69h9mn.first : $_6kydfw164jn69h9mn.last;
  ...
  var search$1 = function (doc, node, x) {
    var f = $_288vghyojn69h6sj.children(node).length === 0 ? locateInEmpty : locateInElement;
    return f(doc, node, x);
  };
  var $_79mtfk163jn69h9mm = { search: search$1 };
  ...
  var searchTextNodes = function (doc, node, x, y) {
    ...
    var boundedX = Math.max(rect.left, Math.min(rect.right, x));
    var boundedY = Math.max(rect.top, Math.min(rect.bottom, y));
    return $_ehq75v160jn69h9m0.locate(doc, node, boundedX, boundedY);
  };
  var searchFromPoint = function (doc, x, y) {
    return Element$$1.fromPoint(doc, x, y).bind(function (elem) {
      var fallback = function () {
        return $_79mtfk163jn69h9mm.search(doc, elem, x);
      };
      return $_288vghyojn69h6sj.children(elem).length === 0 ? fallback() : searchTextNodes(doc, elem, x, y).orThunk(fallback);
    });
  };
  ...
  var fromPoint$1 = function (win, x, y) {
    ...
    return availableSearch(doc, x, y).map(function (rng) {
      return $_19sjbb15sjn69h9k9.range(Element$$1.fromDom(rng.startContainer), rng.startOffset, Element$$1.fromDom(rng.endContainer), rng.endOffset);
    });
  };
  var $_4ar2fo15zjn69h9lu = { fromPoint: fromPoint$1 };

  var withinContainer = function (win, ancestor, outerRange, selector) {
    var innerRange = $_8mc4ca15xjn69h9l5.create(win);
    var self = $_facyuayzjn69h6vi.is(ancestor, selector) ? [ancestor] : [];
    var elements = self.concat($_2km9pz11ajn69h7ky.descendants(ancestor, selector));
    return filter(elements, function (elem) {
      $_8mc4ca15xjn69h9l5.selectNodeContentsUsing(innerRange, elem);
      return $_8mc4ca15xjn69h9l5.isWithin(outerRange, innerRange);
    });
  };
  var find$3 = function (win, selection, selector) {
    var outerRange = $_1qab5115yjn69h9lf.asLtrRange(win, selection);
    var ancestor = Element$$1.fromDom(outerRange.commonAncestorContainer);
    return $_3h5eqmyljn69h6s6.isElement(ancestor) ? withinContainer(win, ancestor, outerRange, selector) : [];
  };
  var $_bocqyz165jn69h9mn = { find: find$3 };

  var beforeSpecial = function (element, offset) {
    var name = $_3h5eqmyljn69h6s6.name(element);
    if ('input' === name)
      return $_gi3sbx15tjn69h9kh.after(element);
    else if (!contains([
        'br',
        'img'
      ], name))
      return $_gi3sbx15tjn69h9kh.on(element, offset);
    else
      return offset === 0 ? $_gi3sbx15tjn69h9kh.before(element) : $_gi3sbx15tjn69h9kh.after(element);
  };
  var preprocessRelative = function (startSitu, finishSitu) {
    var start = startSitu.fold($_gi3sbx15tjn69h9kh.before, beforeSpecial, $_gi3sbx15tjn69h9kh.after);
    var finish = finishSitu.fold($_gi3sbx15tjn69h9kh.before, beforeSpecial, $_gi3sbx15tjn69h9kh.after);
    return $_19sjbb15sjn69h9k9.relative(start, finish);
  };
  var preprocessExact = function (start, soffset, finish, foffset) {
    var startSitu = beforeSpecial(start, soffset);
    var finishSitu = beforeSpecial(finish, foffset);
    return $_19sjbb15sjn69h9k9.relative(startSitu, finishSitu);
  };
  ...
  var doSetRange = function (win, start, soffset, finish, foffset) {
    var rng = $_8mc4ca15xjn69h9l5.exactToNative(win, start, soffset, finish, foffset);
    doSetNativeRange(win, rng);
  };
  var findWithin = function (win, selection, selector) {
    return $_bocqyz165jn69h9mn.find(win, selection, selector);
  };
  ...
  var setRangeFromRelative = function (win, relative) {
    return $_1qab5115yjn69h9lf.diagnose(win, relative).match({
      ltr: function (start, soffset, finish, foffset) {
  ...
  var setExact = function (win, start, soffset, finish, foffset) {
    var relative = $_g9hju6166jn69h9mn.preprocessExact(start, soffset, finish, foffset);
    setRangeFromRelative(win, relative);
  };
  var setRelative = function (win, startSitu, finishSitu) {
    var relative = $_g9hju6166jn69h9mn.preprocessRelative(startSitu, finishSitu);
    setRangeFromRelative(win, relative);
  };
  var toNative = function (selection) {
    var win = $_19sjbb15sjn69h9k9.getWin(selection).dom();
    var getDomRange = function (start, soffset, finish, foffset) {
      return $_8mc4ca15xjn69h9l5.exactToNative(win, start, soffset, finish, foffset);
    };
    var filtered = $_g9hju6166jn69h9mn.preprocess(selection);
    return $_1qab5115yjn69h9lf.diagnose(win, filtered).match({
      ltr: getDomRange,
      rtl: getDomRange
    });
  };
  var readRange = function (selection) {
    if (selection.rangeCount > 0) {
      ...
      return Option.some($_19sjbb15sjn69h9k9.range(Element$$1.fromDom(firstRng.startContainer), firstRng.startOffset, Element$$1.fromDom(lastRng.endContainer), lastRng.endOffset));
    } else {
      return Option.none();
    }
  };
  var doGetExact = function (selection) {
    ...
    return $_9moxqb15vjn69h9ky.after(anchorNode, selection.anchorOffset, focusNode, selection.focusOffset) ? Option.some($_19sjbb15sjn69h9k9.range(Element$$1.fromDom(selection.anchorNode), selection.anchorOffset, Element$$1.fromDom(selection.focusNode), selection.focusOffset)) : readRange(selection);
  };
  var setToElement = function (win, element) {
    var rng = $_8mc4ca15xjn69h9l5.selectNodeContents(win, element);
    doSetNativeRange(win, rng);
  };
  ...
  var get$14 = function (win) {
    return getExact(win).map(function (range) {
      return $_19sjbb15sjn69h9k9.exact(range.start(), range.soffset(), range.finish(), range.foffset());
    });
  };
  var getFirstRect$1 = function (win, selection) {
    var rng = $_1qab5115yjn69h9lf.asLtrRange(win, selection);
    return $_8mc4ca15xjn69h9l5.getFirstRect(rng);
  };
  var getBounds$1 = function (win, selection) {
    var rng = $_1qab5115yjn69h9lf.asLtrRange(win, selection);
    return $_8mc4ca15xjn69h9l5.getBounds(rng);
  };
  var getAtPoint = function (win, x, y) {
    return $_4ar2fo15zjn69h9lu.fromPoint(win, x, y);
  };
  var getAsString = function (win, selection) {
    var rng = $_1qab5115yjn69h9lf.asLtrRange(win, selection);
    return $_8mc4ca15xjn69h9l5.toString(rng);
  };
  ...
  var clone$3 = function (win, selection) {
    var rng = $_1qab5115yjn69h9lf.asLtrRange(win, selection);
    return $_8mc4ca15xjn69h9l5.cloneFragment(rng);
  };
  var replace = function (win, selection, elements) {
    var rng = $_1qab5115yjn69h9lf.asLtrRange(win, selection);
    var fragment = $_b0ttme15wjn69h9kz.fromElements(elements, win.document);
    $_8mc4ca15xjn69h9l5.replaceWith(rng, fragment);
  };
  var deleteAt = function (win, selection) {
    var rng = $_1qab5115yjn69h9lf.asLtrRange(win, selection);
    $_8mc4ca15xjn69h9l5.deleteContents(rng);
  };
  var isCollapsed = function (start, soffset, finish, foffset) {
    return $_bvdidiyujn69h6ug.eq(start, finish) && soffset === foffset;
  };
  var $_4jrll15ujn69h9kp = {
    setExact: setExact,
    getExact: getExact,
    get: get$14,
  ...
  var getRectsFromRange = function (range$$1) {
    if (!range$$1.collapsed) {
      ...
      return $_288vghyojn69h6sj.parent(start_1).bind(function (parent) {
        var selection = $_19sjbb15sjn69h9k9.exact(start_1, range$$1.startOffset, parent, $_cjr7py15pjn69h9js.getEnd(parent));
        var optRect = $_4jrll15ujn69h9kp.getFirstRect(range$$1.startContainer.ownerDocument.defaultView, selection);
  ...
  var $_36iogs15ojn69h9j8 = { getRectangles: getRectangles };
  ...
  var resume = function (cWin) {
    ...
    var inInput = $_cu8ag3102jn69h773.active().exists(function (elem) {
      return contains([
        'input',
        'textarea'
      ], $_3h5eqmyljn69h6s6.name(elem));
    });
    var transaction = inInput ? autocompleteHack() : apply;
    transaction(function () {
      $_cu8ag3102jn69h773.active().each($_cu8ag3102jn69h773.blur);
      $_cu8ag3102jn69h773.focus(iBody);
    });
  };
  var $_fpjtqj167jn69h9n3 = { resume: resume };

  var EXTRA_SPACING = 50;
  var data = 'data-' + $_fhb67k10ujn69h7ft.resolve('last-outer-height');
  var setLastHeight = function (cBody, value) {
    $_68237pzxjn69h76e.set(cBody, data, value);
  };
  var getLastHeight = function (cBody) {
    return $_chg5zh15njn69h9j3.safeParse(cBody, data);
  };
  ...
  var getBounds$2 = function (cWin) {
    var rects = $_36iogs15ojn69h9j8.getRectangles(cWin);
  ...
  var setup$1 = function (outerWindow, cWin) {
    ...
    var toEditing = function () {
      $_fpjtqj167jn69h9n3.resume(cWin);
    };
    var onResize = $_ct4oxc15djn69h9eq.bind(Element$$1.fromDom(outerWindow), 'resize', function () {
  ...
  var $_2rq1ne15mjn69h9ie = { setup: setup$1 };
  ...
  var getSelectionFromFrame = function (frame) {
    ...
    return optWin.bind($_4jrll15ujn69h9kp.getExact);
  };
  ...
  var getOrListen = function (editor, doc, name, type) {
    return editor[name].getOrThunk(function () {
      return function (handler) {
        return $_ct4oxc15djn69h9eq.bind(doc, type, handler);
      };
    });
  };
  ...
  var getActiveApi = function (editor) {
    ...
    var tryFallbackBox = function (win) {
      ...
      return $_4jrll15ujn69h9kp.getExact(win).filter(isCollapsed).bind(toStartRect);
    };
      ...
      return getDocFromFrame(frame).bind(function (doc) {
        return getWinFromFrame(frame).map(function (win) {
          ...
          var getCursorBox = editor.getCursorBox.getOrThunk(function () {
            return function () {
              return $_4jrll15ujn69h9kp.get(win).bind(function (sel) {
                return $_4jrll15ujn69h9kp.getFirstRect(win, sel).orThunk(function () {
          ...
          var setSelection = editor.setSelection.getOrThunk(function () {
            return function (start, soffset, finish, foffset) {
              $_4jrll15ujn69h9kp.setExact(win, start, soffset, finish, foffset);
            };
          });
          var clearSelection = editor.clearSelection.getOrThunk(function () {
            return function () {
              $_4jrll15ujn69h9kp.clear(win);
            };
          });
          return {
            body: constant(body),
  ...
  var isAndroid = $_bc3j7by4jn69h6no.detect().os.isAndroid();
  var matchColor = function (editorBody) {
    var color = $_exugep117jn69h7jh.get(editorBody, 'background-color');
    return color !== undefined && color !== '' ? 'background-color:' + color + '!important' : bgFallback;
  };
  var clobberStyles = function (container, editorBody) {
    var gatherSibilings = function (element) {
      var siblings = $_2km9pz11ajn69h7ky.siblings(element, '*');
      return siblings;
    };
    var clobber = function (clobberStyle) {
      return function (element) {
        var styles = $_68237pzxjn69h76e.get(element, 'style');
        var backup = styles === undefined ? 'no-styles' : styles.trim();
        if (backup === clobberStyle) {
          return;
        } else {
          $_68237pzxjn69h76e.set(element, attr, backup);
          $_68237pzxjn69h76e.set(element, 'style', clobberStyle);
        }
      };
    };
    var ancestors = $_2km9pz11ajn69h7ky.ancestors(container, '*');
  ...
  var restoreStyles = function () {
    var clobberedEls = $_2km9pz11ajn69h7ky.all('[' + attr + ']');
    each$1(clobberedEls, function (element) {
      var restore = $_68237pzxjn69h76e.get(element, attr);
      if (restore !== 'no-styles') {
        $_68237pzxjn69h76e.set(element, 'style', restore);
      } else {
        $_68237pzxjn69h76e.remove(element, 'style');
      }
      $_68237pzxjn69h76e.remove(element, attr);
  ...
  var $_co88al169jn69h9ny = {
    clobberStyles: clobberStyles,
    restoreStyles: restoreStyles
  };

  var tag = function () {
    var head = $_9ipd3211cjn69h7ls.first('head').getOrDie();
    var nu = function () {
      var meta = Element$$1.fromTag('meta');
      $_68237pzxjn69h76e.set(meta, 'name', 'viewport');
      $_4lsz7aynjn69h6sf.append(head, meta);
      return meta;
    };
    var element = $_9ipd3211cjn69h7ls.first('meta[name="viewport"]').getOrThunk(nu);
    var backup = $_68237pzxjn69h76e.get(element, 'content');
    var maximize = function () {
      $_68237pzxjn69h76e.set(element, 'content', 'width=device-width, initial-scale=1.0, user-scalable=no, maximum-scale=1.0');
    };
    var restore = function () {
      if (backup !== undefined && backup !== null && backup.length > 0) {
        $_68237pzxjn69h76e.set(element, 'content', backup);
      } else {
        $_68237pzxjn69h76e.set(element, 'content', 'user-scalable=yes');
      }
    };
    return {
      maximize: maximize,
  ...
  var $_dnnut716ajn69h9oi = { tag: tag };

  var create$5 = function (platform, mask) {
    var meta = $_dnnut716ajn69h9oi.tag();
    var androidApi = api$2();
    var androidEvents = api$2();
    var enter = function () {
      mask.hide();
      $_f5i2mxzvjn69h769.add(platform.container, $_fhb67k10ujn69h7ft.resolve('fullscreen-maximized'));
      $_f5i2mxzvjn69h769.add(platform.container, $_fhb67k10ujn69h7ft.resolve('android-maximized'));
      meta.maximize();
      $_f5i2mxzvjn69h769.add(platform.body, $_fhb67k10ujn69h7ft.resolve('android-scroll-reload'));
      androidApi.set($_2rq1ne15mjn69h9ie.setup(platform.win, $_2n6wdc168jn69h9nj.getWin(platform.editor).getOrDie('no')));
      $_2n6wdc168jn69h9nj.getActiveApi(platform.editor).each(function (editorApi) {
        $_co88al169jn69h9ny.clobberStyles(platform.container, editorApi.body());
        androidEvents.set($_gckgpj15ijn69h9g4.initEvents(editorApi, platform.toolstrip, platform.alloy));
      });
    };
    var exit = function () {
      meta.restore();
      mask.show();
      $_f5i2mxzvjn69h769.remove(platform.container, $_fhb67k10ujn69h7ft.resolve('fullscreen-maximized'));
      $_f5i2mxzvjn69h769.remove(platform.container, $_fhb67k10ujn69h7ft.resolve('android-maximized'));
      $_co88al169jn69h9ny.restoreStyles();
      $_f5i2mxzvjn69h769.remove(platform.body, $_fhb67k10ujn69h7ft.resolve('android-scroll-reload'));
      androidEvents.clear();
      androidApi.clear();
    };
    return {
  ...
  var $_aagzzd15hjn69h9fs = { create: create$5 };
  ...
  var sketch$10 = function (onView, translate) {
    var memIcon = record(Container.sketch({
      ...
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_fhb67k10ujn69h7ft.resolve('mask-tap-icon-selected'),
          toggleOnExecute: false
        })])
    }));
    ...
    return Container.sketch({
      ...
      components: [Container.sketch({
          ...
          components: [Button.sketch({
              ...
              buttonBehaviours: derive$2([Toggling.config({ toggleClass: $_fhb67k10ujn69h7ft.resolve('mask-tap-icon-selected') })])
            })]
        })]
    });
  };
  var $_7o52hq16bjn69h9ox = { sketch: sketch$10 };
  ...
  var MobileSchema = objOf([
    ...
    state$1('win', function (spec) {
      return $_288vghyojn69h6sj.owner(spec.socket).dom().defaultView;
    }),
  ...
  var produce = function (raw) {
    ...
    $_exugep117jn69h7jh.set(mobile.toolstrip, 'width', '100%');
    var onTap = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_7o52hq16bjn69h9ox.sketch(onTap, mobile.translate));
    ...
    $_4lsz7aynjn69h6sf.append(mobile.container, mask.element());
    var mode = $_aagzzd15hjn69h9fs.create(mobile, maskApi);
    return {
  ...
  var $_1r9e8h15gjn69h9fc = { produce: produce };
  ...
  var dataHorizontal = 'data-' + $_fhb67k10ujn69h7ft.resolve('horizontal-scroll');
  ...
  var markAsHorizontal = function (container) {
    $_68237pzxjn69h76e.set(container, dataHorizontal, 'true');
  };
  var hasScroll = function (container) {
    return $_68237pzxjn69h76e.get(container, dataHorizontal) === 'true' ? hasHorizontalScroll(container) : hasVerticalScroll(container);
  };
  var exclusive = function (scope, selector) {
    return $_ct4oxc15djn69h9eq.bind(scope, 'touchmove', function (event) {
      $_9ipd3211cjn69h7ls.closest(event.target(), selector).filter(hasScroll).fold(function () {
        event.raw().preventDefault();
      }, noop);
    });
  };
  var $_9xfsni16jjn69h9st = {
    exclusive: exclusive,
  ...
  function ScrollingToolbar () {
    var makeGroup = function (gSpec) {
      ...
      return {
        ...
        tgroupBehaviours: derive$2([config('adhoc-scrollable-toolbar', gSpec.scrollable === true ? [runOnInit(function (component, simulatedEvent) {
              $_exugep117jn69h7jh.set(component.element(), 'overflow-x', 'auto');
              $_9xfsni16jjn69h9st.markAsHorizontal(component.element());
              $_oghq815ajn69h9dv.register(component.element());
            })] : [])]),
        components: [Container.sketch({ components: [ToolbarGroup.parts().items({})] })],
        markers: { itemClass: $_fhb67k10ujn69h7ft.resolve('toolbar-group-item') },
        items: gSpec.items
      };
    };
    var toolbar = build$1(Toolbar.sketch({
      ...
      toolbarBehaviours: derive$2([
        Toggling.config({
          toggleClass: $_fhb67k10ujn69h7ft.resolve('context-toolbar'),
          toggleOnExecute: false,
          aria: { mode: 'none' }
        }),
    ...
    var wrapper = build$1(Container.sketch({
      dom: { classes: [$_fhb67k10ujn69h7ft.resolve('toolstrip')] },
      components: [premade$1(toolbar)],
      containerBehaviours: derive$2([Toggling.config({
          toggleClass: $_fhb67k10ujn69h7ft.resolve('android-selection-context-toolbar'),
          toggleOnExecute: false
        })])
    }));
  ...
  var disableTransitions = function (component, slideConfig) {
    ...
    $_eoomzq14njn69h94y.remove(root, [
      slideConfig.shrinkingClass(),
      slideConfig.growingClass()
    ]);
  };
  var setShrunk = function (component, slideConfig) {
    $_f5i2mxzvjn69h769.remove(component.element(), slideConfig.openClass());
    $_f5i2mxzvjn69h769.add(component.element(), slideConfig.closedClass());
    $_exugep117jn69h7jh.set(component.element(), getDimensionProperty(slideConfig), '0px');
    $_exugep117jn69h7jh.reflow(component.element());
  };
  ...
  var setGrown = function (component, slideConfig) {
    $_f5i2mxzvjn69h769.remove(component.element(), slideConfig.closedClass());
    $_f5i2mxzvjn69h769.add(component.element(), slideConfig.openClass());
    $_exugep117jn69h7jh.remove(component.element(), getDimensionProperty(slideConfig));
  };
  var doImmediateShrink = function (component, slideConfig, slideState) {
    slideState.setCollapsed();
    $_exugep117jn69h7jh.set(component.element(), getDimensionProperty(slideConfig), getDimension(slideConfig, component.element()));
    $_exugep117jn69h7jh.reflow(component.element());
  ...
  var doStartShrink = function (component, slideConfig, slideState) {
    ...
    $_exugep117jn69h7jh.reflow(component.element());
    var root = getAnimationRoot(component, slideConfig);
    $_f5i2mxzvjn69h769.add(root, slideConfig.shrinkingClass());
    setShrunk(component, slideConfig);
    slideConfig.onStartShrink()(component);
  };
  var doStartGrow = function (component, slideConfig, slideState) {
    ...
    var root = getAnimationRoot(component, slideConfig);
    $_f5i2mxzvjn69h769.add(root, slideConfig.growingClass());
    setGrown(component, slideConfig);
    $_exugep117jn69h7jh.set(component.element(), getDimensionProperty(slideConfig), fullSize);
  ...
  var isGrowing = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_f5i2mxzvjn69h769.has(root, slideConfig.growingClass()) === true;
  };
  var isShrinking = function (component, slideConfig, slideState) {
    var root = getAnimationRoot(component, slideConfig);
    return $_f5i2mxzvjn69h769.has(root, slideConfig.shrinkingClass()) === true;
  };
  ...
  var events$10 = function (slideConfig, slideState) {
    return derive([run(transitionend(), function (component, simulatedEvent) {
        ...
        if (raw.propertyName === slideConfig.dimension().property()) {
          disableTransitions(component, slideConfig);
          if (slideState.isExpanded()) {
            $_exugep117jn69h7jh.remove(component.element(), slideConfig.dimension().property());
          }
    ...
    strictOf('dimension', choose$1('property', {
      width: [
        ...
        output$1('getDimension', function (elem) {
          return $_3l0w5b131jn69h8e6.get(elem) + 'px';
        })
      ],
      height: [
        output$1('property', 'height'),
        output$1('getDimension', function (elem) {
          return $_bmsr1a116jn69h7je.get(elem) + 'px';
        })
      ]
    }))
  ];
  ...
  var build$2 = function (refresh, scrollIntoView) {
    var dropup = build$1(Container.sketch({
      dom: {
        tag: 'div',
        classes: [$_fhb67k10ujn69h7ft.resolve('dropup')]
      },
      components: [],
      containerBehaviours: derive$2([
        Replacing.config({}),
        Sliding.config({
          closedClass: $_fhb67k10ujn69h7ft.resolve('dropup-closed'),
          openClass: $_fhb67k10ujn69h7ft.resolve('dropup-open'),
          shrinkingClass: $_fhb67k10ujn69h7ft.resolve('dropup-shrinking'),
          growingClass: $_fhb67k10ujn69h7ft.resolve('dropup-growing'),
        ...
        $_6mmxim10tjn69h7fm.orientation(function (component, data) {
          disappear(noop);
        })
      ])
    }));
  ...
  var isDangerous = function (event$$1) {
    ...
    return keyEv.which === BACKSPACE()[0] && !contains([
      'input',
      'textarea'
    ], $_3h5eqmyljn69h6s6.name(event$$1.target()));
  };
  var isFirefox = $_bc3j7by4jn69h6no.detect().browser.isFirefox();
  ...
  var bindFocus = function (container, handler) {
    if (isFirefox) {
      return $_ct4oxc15djn69h9eq.capture(container, 'focus', handler);
    } else {
      return $_ct4oxc15djn69h9eq.bind(container, 'focusin', handler);
    }
  };
  var bindBlur = function (container, handler) {
    if (isFirefox) {
      return $_ct4oxc15djn69h9eq.capture(container, 'blur', handler);
    } else {
      return $_ct4oxc15djn69h9eq.bind(container, 'focusout', handler);
    }
  };
  var setup$2 = function (container, rawSettings) {
    var settings = asRawOrDie('Getting GUI events settings', settingsSchema, rawSettings);
    var pointerEvents = $_bc3j7by4jn69h6no.detect().deviceType.isTouch() ? [
      'touchstart',
      'touchmove',
      'touchend',
      'gesturestart'
    ...
    var simpleEvents = map$1(pointerEvents.concat([
      ...
      return $_ct4oxc15djn69h9eq.bind(container, type, function (event$$1) {
    ...
    var onKeydown = $_ct4oxc15djn69h9eq.bind(container, 'keydown', function (event$$1) {
    ...
    var defaultView = $_288vghyojn69h6sj.defaultView(container);
    var onWindowScroll = $_ct4oxc15djn69h9eq.bind(defaultView, 'scroll', function (event$$1) {
  ...
  var doTriggerHandler = function (lookup, eventType, rawEvent, target, source, logger) {
    ...
    return handler.fold(function () {
      ...
      if (simulatedEvent.isStopped()) {
        ...
        return $_288vghyojn69h6sj.parent(handlerInfo.element()).fold(function () {
  ...
  var closest$3 = function (target, transform, isRoot) {
    var delegate = $_ctt4rn104jn69h77u.closest(target, function (elem) {
  ...
  function Registry () {
    ...
    var failOnDuplicate = function (component, tagId) {
      ...
      if (conflict === component) {
        ...
        throw new Error('The tagId "' + tagId + '" is already used by: ' + element(conflict.element()) + '\nCannot use it for: ' + element(component.element()) + '\n' + 'The conflicting element is' + ($_26b9v2yjjn69h6ra.inBody(conflict.element()) ? ' ' : ' not ') + 'already in the DOM');
      }
    };
  ...
  var takeover = function (root) {
    var isAboveRoot = function (el) {
      return $_288vghyojn69h6sj.parent(root.element()).fold(function () {
        return true;
      }, function (parent) {
        return $_bvdidiyujn69h6ug.eq(el, parent);
      });
    };
    ...
    var systemApi = SystemApi({
      ...
      triggerFocus: function (target, originator) {
        read$2(target).fold(function () {
          $_cu8ag3102jn69h773.focus(target);
        }, function (_alloyId) {
    ...
    var addToWorld = function (component) {
      ...
      if (!$_3h5eqmyljn69h6s6.isText(component.element())) {
    ...
    var destroy = function () {
      domEvents.unbind();
      $_1fffmzz0jn69h6vi.remove(root.element());
    };
  ...
  var READ_ONLY_MODE_CLASS = constant($_fhb67k10ujn69h7ft.resolve('readonly-mode'));
  var EDIT_MODE_CLASS = constant($_fhb67k10ujn69h7ft.resolve('edit-mode'));
  function OuterContainer (spec) {
    var root = build$1(Container.sketch({
      dom: { classes: [$_fhb67k10ujn69h7ft.resolve('outer-container')].concat(spec.classes) },
  ...
  function AndroidRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_fhb67k10ujn69h7ft.resolve('android-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_cjsy4u16kjn69h9t5.makeEditSwitch(webapp);
    var socket = $_cjsy4u16kjn69h9t5.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_1r9e8h15gjn69h9fc.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        w.exit();
    ...
    var updateMode = function (readOnly) {
      $_cjsy4u16kjn69h9t5.updateMode(socket, switchToEdit, readOnly, alloy.root());
    };
    return {
  ...
  var input$1 = function (parent, operation) {
    ...
    $_exugep117jn69h7jh.setAll(input, {
      opacity: '0',
      position: 'absolute',
      top: '-1000px',
      left: '-1000px'
    });
    $_4lsz7aynjn69h6sf.append(parent, input);
    $_cu8ag3102jn69h773.focus(input);
    operation(input);
    $_1fffmzz0jn69h6vi.remove(input);
  };
  var $_f90m5w174jn69ha22 = { input: input$1 };
  ...
  var $_dnhzz5176jn69ha2y = {
    refreshInput: refreshInput,
    refresh: refresh
  };

  var resume$1 = function (cWin, frame) {
    $_cu8ag3102jn69h773.active().each(function (active) {
      if (!$_bvdidiyujn69h6ug.eq(active, frame)) {
        $_cu8ag3102jn69h773.blur(active);
      }
    });
    cWin.focus();
    $_cu8ag3102jn69h773.focus(Element$$1.fromDom(cWin.document.body));
    $_dnhzz5176jn69ha2y.refresh(cWin);
  };
  var $_acud77175jn69ha2m = { resume: resume$1 };

  var stubborn = function (outerBody, cWin, page, frame) {
    var toEditing = function () {
      $_acud77175jn69ha2m.resume(cWin, frame);
    };
    var toReading = function () {
      $_f90m5w174jn69ha22.input(outerBody, $_cu8ag3102jn69h773.blur);
    };
    var captureInput = $_ct4oxc15djn69h9eq.bind(page, 'keydown', function (evt) {
      if (!contains([
          'input',
          'textarea'
        ], $_3h5eqmyljn69h6s6.name(evt.target()))) {
        toEditing();
      }
    });
  ...
  var initEvents$1 = function (editorApi, iosApi, toolstrip, socket, dropup) {
    ...
    var reposition = function () {
      var toolbarHeight = $_bmsr1a116jn69h7je.get(toolstrip);
      iosApi.run(function (api) {
    ...
    var listeners = [
      ...
      $_ct4oxc15djn69h9eq.bind(editorApi.doc(), 'touchend', function (touchEvent) {
        if ($_bvdidiyujn69h6ug.eq(editorApi.html(), touchEvent.target()) || $_bvdidiyujn69h6ug.eq(editorApi.body(), touchEvent.target())) {
        }
      }),
      $_ct4oxc15djn69h9eq.bind(toolstrip, 'transitionend', function (transitionEvent) {
        if (transitionEvent.raw().propertyName === 'height') {
          reposition();
        }
      }),
      $_ct4oxc15djn69h9eq.capture(toolstrip, 'touchstart', function (touchEvent) {
        saveSelectionFirst();
      ...
      tapping.onTouchmove(),
      tapping.onTouchend(),
      $_ct4oxc15djn69h9eq.bind(editorApi.body(), 'click', function (event) {
        event.kill();
      }),
      $_ct4oxc15djn69h9eq.bind(toolstrip, 'touchmove', function () {
  ...
  var $_8v5wdg177jn69ha35 = { initEvents: initEvents$1 };

  function FakeSelection (win, frame) {
    var doc = win.document;
    var container = Element$$1.fromTag('div');
    $_f5i2mxzvjn69h769.add(container, $_fhb67k10ujn69h7ft.resolve('unfocused-selections'));
    $_4lsz7aynjn69h6sf.append(Element$$1.fromDom(doc.documentElement), container);
    var onTouch = $_ct4oxc15djn69h9eq.bind(container, 'touchstart', function (event) {
      event.prevent();
      $_acud77175jn69ha2m.resume(win, frame);
      clear();
    });
    var make = function (rectangle) {
      var span = Element$$1.fromTag('span');
      $_eoomzq14njn69h94y.add(span, [
        $_fhb67k10ujn69h7ft.resolve('layer-editor'),
        $_fhb67k10ujn69h7ft.resolve('unfocused-selection')
      ]);
      $_exugep117jn69h7jh.setAll(span, {
    ...
    var update = function () {
      clear();
      var rectangles = $_36iogs15ojn69h9j8.getRectangles(win);
      var spans = map$1(rectangles, make);
      $_cdlb12z1jn69h6vx.append(container, spans);
    };
    var clear = function () {
      $_1fffmzz0jn69h6vi.empty(container);
    };
    var destroy = function () {
      onTouch.unbind();
      $_1fffmzz0jn69h6vi.remove(container);
    };
    var isActive = function () {
      return $_288vghyojn69h6sj.children(container).length > 0;
    };
    return {
      update: update,
      isActive: isActive,
  ...
  var $_bzw5yb17hjn69ha6n = { findDevice: findDevice };

  var softKeyboardLimits = function (outerWindow) {
    return $_bzw5yb17hjn69ha6n.findDevice(outerWindow.screen.width, outerWindow.screen.height);
  };
  var accountableKeyboardHeight = function (outerWindow) {
    var portrait = $_i78g715cjn69h9ea.get(outerWindow).isPortrait();
  ...
  var getGreenzone = function (socket, dropup) {
    var outerWindow = $_288vghyojn69h6sj.owner(socket).dom().defaultView;
    var viewportHeight = $_bmsr1a116jn69h7je.get(socket) + $_bmsr1a116jn69h7je.get(dropup);
  ...
  var updatePadding = function (contentBody, socket, dropup) {
    ...
    var deltaHeight = $_bmsr1a116jn69h7je.get(socket) + $_bmsr1a116jn69h7je.get(dropup) - greenzoneHeight;
    $_exugep117jn69h7jh.set(contentBody, 'padding-bottom', deltaHeight + 'px');
  };
  var $_bb0nly17gjn69ha6e = {
  ...
  var yFixedData = 'data-' + $_fhb67k10ujn69h7ft.resolve('position-y-fixed');
  var yFixedProperty = 'data-' + $_fhb67k10ujn69h7ft.resolve('y-property');
  var yScrollingData = 'data-' + $_fhb67k10ujn69h7ft.resolve('scrolling');
  var windowSizeData = 'data-' + $_fhb67k10ujn69h7ft.resolve('last-window-height');
  var getYFixedData = function (element) {
    return $_chg5zh15njn69h9j3.safeParse(element, yFixedData);
  };
  var getYFixedProperty = function (element) {
    return $_68237pzxjn69h76e.get(element, yFixedProperty);
  };
  var getLastWindowSize = function (element) {
    return $_chg5zh15njn69h9j3.safeParse(element, windowSizeData);
  };
  ...
  var classify = function (element) {
    ...
    var classifier = $_68237pzxjn69h76e.get(element, yScrollingData) === 'true' ? classifyScrolling : classifyFixed;
    return classifier(element, offsetY);
  };
  var findFixtures = function (container) {
    var candidates = $_2km9pz11ajn69h7ky.descendants(container, '[' + yFixedData + ']');
    return map$1(candidates, classify);
  };
  var takeoverToolbar = function (toolbar) {
    var oldToolbarStyle = $_68237pzxjn69h76e.get(toolbar, 'style');
    $_exugep117jn69h7jh.setAll(toolbar, {
      position: 'absolute',
      top: '0px'
    });
    $_68237pzxjn69h76e.set(toolbar, yFixedData, '0px');
    $_68237pzxjn69h76e.set(toolbar, yFixedProperty, 'top');
    var restore = function () {
      $_68237pzxjn69h76e.set(toolbar, 'style', oldToolbarStyle || '');
      $_68237pzxjn69h76e.remove(toolbar, yFixedData);
      $_68237pzxjn69h76e.remove(toolbar, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverViewport = function (toolbarHeight, height, viewport) {
    var oldViewportStyle = $_68237pzxjn69h76e.get(viewport, 'style');
    $_oghq815ajn69h9dv.register(viewport);
    $_exugep117jn69h7jh.setAll(viewport, {
      position: 'absolute',
      height: height + 'px',
      width: '100%',
      top: toolbarHeight + 'px'
    });
    $_68237pzxjn69h76e.set(viewport, yFixedData, toolbarHeight + 'px');
    $_68237pzxjn69h76e.set(viewport, yScrollingData, 'true');
    $_68237pzxjn69h76e.set(viewport, yFixedProperty, 'top');
    var restore = function () {
      $_oghq815ajn69h9dv.deregister(viewport);
      $_68237pzxjn69h76e.set(viewport, 'style', oldViewportStyle || '');
      $_68237pzxjn69h76e.remove(viewport, yFixedData);
      $_68237pzxjn69h76e.remove(viewport, yScrollingData);
      $_68237pzxjn69h76e.remove(viewport, yFixedProperty);
    };
    return { restore: restore };
  };
  var takeoverDropup = function (dropup, toolbarHeight, viewportHeight) {
    var oldDropupStyle = $_68237pzxjn69h76e.get(dropup, 'style');
    $_exugep117jn69h7jh.setAll(dropup, {
      position: 'absolute',
      bottom: '0px'
    });
    $_68237pzxjn69h76e.set(dropup, yFixedData, '0px');
    $_68237pzxjn69h76e.set(dropup, yFixedProperty, 'bottom');
    var restore = function () {
      $_68237pzxjn69h76e.set(dropup, 'style', oldDropupStyle || '');
      $_68237pzxjn69h76e.remove(dropup, yFixedData);
      $_68237pzxjn69h76e.remove(dropup, yFixedProperty);
    };
    return { restore: restore };
  };
  var deriveViewportHeight = function (viewport, toolbarHeight, dropupHeight) {
    var outerWindow = $_288vghyojn69h6sj.owner(viewport).dom().defaultView;
    var winH = outerWindow.innerHeight;
    $_68237pzxjn69h76e.set(viewport, windowSizeData, winH + 'px');
    return winH - toolbarHeight - dropupHeight;
  };
  var takeover$1 = function (viewport, contentBody, toolbar, dropup) {
    var outerWindow = $_288vghyojn69h6sj.owner(viewport).dom().defaultView;
    var toolbarSetup = takeoverToolbar(toolbar);
    var toolbarHeight = $_bmsr1a116jn69h7je.get(toolbar);
    var dropupHeight = $_bmsr1a116jn69h7je.get(dropup);
    ...
    var refresh = function () {
      if (isActive) {
        var newToolbarHeight = $_bmsr1a116jn69h7je.get(toolbar);
        var dropupHeight_1 = $_bmsr1a116jn69h7je.get(dropup);
        var newHeight = deriveViewportHeight(viewport, newToolbarHeight, dropupHeight_1);
        $_68237pzxjn69h76e.set(viewport, yFixedData, newToolbarHeight + 'px');
        $_exugep117jn69h7jh.set(viewport, 'height', newHeight + 'px');
        $_exugep117jn69h7jh.set(dropup, 'bottom', -(newToolbarHeight + newHeight + dropupHeight_1) + 'px');
        $_bb0nly17gjn69ha6e.updatePadding(contentBody, viewport, dropup);
      }
    };
    var setViewportOffset = function (newYOffset) {
      var offsetPx = newYOffset + 'px';
      $_68237pzxjn69h76e.set(viewport, yFixedData, offsetPx);
      refresh();
    };
    $_bb0nly17gjn69ha6e.updatePadding(contentBody, viewport, dropup);
    return {
  ...
  var $_fdf5iw17fjn69ha5r = {
    findFixtures: findFixtures,
    takeover: takeover$1,
    getYFixedData: getYFixedData
  };

  var animator = $_70vzb317ejn69ha5m.create();
  var ANIMATION_STEP = 15;
  var NUM_TOP_ANIMATION_FRAMES = 10;
  var ANIMATION_RATE = 10;
  var lastScroll = 'data-' + $_fhb67k10ujn69h7ft.resolve('last-scroll-top');
  var getTop = function (element) {
    var raw = $_exugep117jn69h7jh.getRaw(element, 'top').getOr('0');
  ...
  var moveScrollAndTop = function (element, destination, finalTop) {
    return Future.nu(function (callback) {
      ...
      var update = function (newScroll) {
        ...
        $_exugep117jn69h7jh.set(element, 'top', getTop(element) + ANIMATION_STEP + 'px');
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_exugep117jn69h7jh.set(element, 'top', finalTop + 'px');
  ...
  var moveOnlyScroll = function (element, destination) {
    return Future.nu(function (callback) {
      var getCurrent = curry(getScrollTop, element);
      $_68237pzxjn69h76e.set(element, lastScroll, getCurrent());
      var update = function (newScroll, abort) {
        var previous = $_chg5zh15njn69h9j3.safeParse(element, lastScroll);
        if (previous !== element.dom().scrollTop) {
          abort(element.dom().scrollTop);
        } else {
          element.dom().scrollTop = newScroll;
          $_68237pzxjn69h76e.set(element, lastScroll, newScroll);
        }
      };
      var finish = function () {
        element.dom().scrollTop = destination;
        $_68237pzxjn69h76e.set(element, lastScroll, destination);
        callback(destination);
      };
  ...
  var moveOnlyTop = function (element, destination) {
    return Future.nu(function (callback) {
      ...
      var update = function (newTop) {
        $_exugep117jn69h7jh.set(element, 'top', newTop + 'px');
      };
      var finish = function () {
        update(destination);
        callback(destination);
  ...
  var updateTop = function (element, amount) {
    var newTop = amount + $_fdf5iw17fjn69ha5r.getYFixedData(element) + 'px';
    $_exugep117jn69h7jh.set(element, 'top', newTop);
  };
  var moveWindowScroll = function (toolbar, viewport, destY) {
    var outerWindow = $_288vghyojn69h6sj.owner(toolbar).dom().defaultView;
    return Future.nu(function (callback) {
  ...
  var scrollIntoView = function (cWin, socket, dropup, top, bottom) {
    var greenzone = $_bb0nly17gjn69ha6e.getGreenzone(socket, dropup);
    var refreshCursor = curry($_dnhzz5176jn69ha2y.refresh, cWin);
    if (top > greenzone || bottom > greenzone) {
      $_cn5mnc17ajn69ha4x.moveOnlyScroll(socket, socket.dom().scrollTop - greenzone + bottom).get(refreshCursor);
    } else if (top < 0) {
      $_cn5mnc17ajn69ha4x.moveOnlyScroll(socket, socket.dom().scrollTop + top).get(refreshCursor);
    } else {
    }
  };
  var $_ee20uz17jjn69ha73 = { scrollIntoView: scrollIntoView };
  ...
  var updateFixed = function (element, property, winY, offsetY) {
    ...
    $_exugep117jn69h7jh.set(element, property, destination + 'px');
    return Future.pure(offsetY);
  };
  var updateScrollingFixed = function (element, winY, offsetY) {
    var destTop = winY + offsetY;
    var oldProp = $_exugep117jn69h7jh.getRaw(element, 'top').getOr(offsetY);
    var delta = destTop - parseInt(oldProp, 10);
    var destScroll = element.dom().scrollTop + delta;
    return $_cn5mnc17ajn69ha4x.moveScrollAndTop(element, destScroll, destTop);
  };
  ...
  var register$2 = function (toolstrip, socket, container, outerWindow, structure, cWin) {
    ...
    var scrollThrottle = last$3(function () {
      scroller.idle(function () {
        $_ds8k0317kjn69ha7d.updatePositions(container, outerWindow.pageYOffset).get(function () {
    ...
    var onScroll = $_ct4oxc15djn69h9eq.bind(Element$$1.fromDom(outerWindow), 'scroll', function () {
      if (outerWindow.pageYOffset < 0) {
        return;
      }
      scrollThrottle.throttle();
    });
    $_ds8k0317kjn69ha7d.updatePositions(container, outerWindow.pageYOffset).get(identity);
  ...
  var setup$3 = function (bag) {
    ...
    var structure = $_fdf5iw17fjn69ha5r.takeover(socket, ceBody, toolstrip, dropup);
    var keyboardModel = keyboardType(bag.outerBody(), cWin, $_26b9v2yjjn69h6ra.body(), contentElement, toolstrip, toolbar);
    var toEditing = function () {
    ...
    var onOrientation = $_i78g715cjn69h9ea.onChange(outerWindow, {
      onChange: noop,
    ...
    var scrollIntoView = function (top, bottom) {
      $_ee20uz17jjn69ha73.scrollIntoView(cWin, socket, dropup, top, bottom);
    };
    var syncHeight = function () {
      $_exugep117jn69h7jh.set(contentElement, 'height', contentElement.dom().contentWindow.document.body.scrollHeight + 'px');
    };
    var setViewportOffset = function (newYOffset) {
      structure.setViewportOffset(newYOffset);
      $_cn5mnc17ajn69ha4x.moveOnlyTop(socket, newYOffset).get(identity);
    };
    var destroy = function () {
      structure.restore();
      ...
      $_f90m5w174jn69ha22.input($_26b9v2yjjn69h6ra.body(), $_cu8ag3102jn69h773.blur);
    };
    return {
      toEditing: toEditing,
      toReading: toReading,
  ...
  var $_4pg46u178jn69ha3k = { setup: setup$3 };
  ...
  var create$8 = function (platform, mask) {
    ...
    var enter = function () {
      ...
      $_2n6wdc168jn69h9nj.getActiveApi(platform.editor).each(function (editorApi) {
        priorState.set({
          socketHeight: $_exugep117jn69h7jh.getRaw(platform.socket, 'height'),
          iframeHeight: $_exugep117jn69h7jh.getRaw(editorApi.frame(), 'height'),
          outerScroll: document.body.scrollTop
        });
        scrollEvents.set({ exclusives: $_9xfsni16jjn69h9st.exclusive(doc, '.' + $_oghq815ajn69h9dv.scrollable()) });
        $_f5i2mxzvjn69h769.add(platform.container, $_fhb67k10ujn69h7ft.resolve('fullscreen-maximized'));
        $_co88al169jn69h9ny.clobberStyles(platform.container, editorApi.body());
        meta.maximize();
        $_exugep117jn69h7jh.set(platform.socket, 'overflow', 'scroll');
        $_exugep117jn69h7jh.set(platform.socket, '-webkit-overflow-scrolling', 'touch');
        $_cu8ag3102jn69h773.focus(editorApi.body());
        ...
        iosApi.set($_4pg46u178jn69ha3k.setup(setupBag({
          cWin: editorApi.win(),
          ...
          keyboardType: $_9ko23x173jn69ha1e.stubborn,
        ...
        iosEvents.set($_8v5wdg177jn69ha35.initEvents(editorApi, iosApi, platform.toolstrip, platform.socket, platform.dropup));
      });
    };
    var exit = function () {
      meta.restore();
      ...
      priorState.on(function (s) {
        s.socketHeight.each(function (h) {
          $_exugep117jn69h7jh.set(platform.socket, 'height', h);
        });
        s.iframeHeight.each(function (h) {
          $_exugep117jn69h7jh.set(platform.editor.getFrame(), 'height', h);
        });
      ...
      $_f5i2mxzvjn69h769.remove(platform.container, $_fhb67k10ujn69h7ft.resolve('fullscreen-maximized'));
      $_co88al169jn69h9ny.restoreStyles();
      $_oghq815ajn69h9dv.deregister(platform.toolbar);
      $_exugep117jn69h7jh.remove(platform.socket, 'overflow');
      $_exugep117jn69h7jh.remove(platform.socket, '-webkit-overflow-scrolling');
      $_cu8ag3102jn69h773.blur(platform.editor.getFrame());
      $_2n6wdc168jn69h9nj.getActiveApi(platform.editor).each(function (editorApi) {
  ...
  var $_1k22hz172jn69ha0s = { create: create$8 };

  var produce$1 = function (raw) {
    var mobile = asRawOrDie('Getting IosWebapp schema', MobileSchema, raw);
    $_exugep117jn69h7jh.set(mobile.toolstrip, 'width', '100%');
    $_exugep117jn69h7jh.set(mobile.container, 'position', 'relative');
    var onView = function () {
      mobile.setReadOnly(mobile.readOnlyOnInit());
      mode.enter();
    };
    var mask = build$1($_7o52hq16bjn69h9ox.sketch(onView, mobile.translate));
    mobile.alloy.add(mask);
    var maskApi = {
      show: function () {
        mobile.alloy.add(mask);
    ...
    var mode = $_1k22hz172jn69ha0s.create(mobile, maskApi);
    return {
      setReadOnly: mobile.setReadOnly,
  ...
  var $_36j4qd171jn69ha0d = { produce: produce$1 };

  function IosRealm (scrollIntoView) {
    var alloy = OuterContainer({ classes: [$_fhb67k10ujn69h7ft.resolve('ios-container')] });
    var toolbar = ScrollingToolbar();
    var webapp = api$2();
    var switchToEdit = $_cjsy4u16kjn69h9t5.makeEditSwitch(webapp);
    var socket = $_cjsy4u16kjn69h9t5.makeSocket();
    ...
    var init = function (spec) {
      webapp.set($_36j4qd171jn69ha0d.produce(spec));
    };
    var exit = function () {
      webapp.run(function (w) {
        Replacing.remove(socket, switchToEdit);
  ...
  var $_51o80r17njn69ha87 = { derive: derive$4 };
  ...
  var fireChange$1 = function (realm, command, state) {
    realm.system().broadcastOn([$_csmiie10ajn69h78i.formatChanged()], {
      command: command,
      state: state
    });
  };
  ...
  var $_amdm3y17qjn69ha8r = { fireSkinLoaded: fireSkinLoaded };

  var READING = constant('toReading');
  var EDITING = constant('toEditing');
  global$1.add('mobile', function (editor) {
    var renderUI = function (args) {
      var cssUrls = $_51o80r17njn69ha87.derive(editor);
      if (isSkinDisabled(editor) === false) {
        editor.contentCSS.push(cssUrls.content);
        global.DOM.styleSheetLoader.load(cssUrls.ui, $_amdm3y17qjn69ha8r.fireSkinLoaded(editor));
      } else {
        $_amdm3y17qjn69ha8r.fireSkinLoaded(editor)();
      }
      var doScrollIntoView = function () {
        editor.fire('scrollIntoView');
      };
      var wrapper = Element$$1.fromTag('div');
      var realm = $_bc3j7by4jn69h6no.detect().os.isAndroid() ? AndroidRealm(doScrollIntoView) : IosRealm(doScrollIntoView);
      var original = Element$$1.fromDom(args.targetNode);
      $_4lsz7aynjn69h6sf.after(original, wrapper);
      attachSystem(wrapper, realm.system());
      var findFocusIn = function (elem) {
        return $_cu8ag3102jn69h773.search(elem).bind(function (focused) {
          return realm.system().getByDom(focused).toOption();
        });
      };
      var outerWindow = args.targetNode.ownerDocument.defaultView;
      var orientation = $_i78g715cjn69h9ea.onChange(outerWindow, {
        onChange: function () {
          var alloy = realm.system();
          alloy.broadcastOn([$_csmiie10ajn69h78i.orientationChanged()], { width: $_i78g715cjn69h9ea.getActualWidth(outerWindow) });
        },
        onReady: noop
      });
      ...
      editor.on('init', function () {
        realm.init({
          editor: {
            ...
            onTouchContent: function () {
              var toolbar = Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_fhb67k10ujn69h7ft.resolve('toolbar')));
            ...
            onTapContent: function (evt) {
              ...
              if ($_3h5eqmyljn69h6s6.name(target) === 'img') {
                editor.selection.select(target.dom());
                evt.kill();
              } else if ($_3h5eqmyljn69h6s6.name(target) === 'a') {
                var component = realm.system().getByDom(Element$$1.fromDom(editor.editorContainer));
                component.each(function (container) {
                  if (Swapping.isAlpha(container)) {
                    $_cxcqqx108jn69h78i.openLink(target.dom());
                  }
                });
              }
            }
          ...
          toolstrip: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_fhb67k10ujn69h7ft.resolve('toolstrip'))),
          toolbar: Element$$1.fromDom(editor.editorContainer.querySelector('.' + $_fhb67k10ujn69h7ft.resolve('toolbar'))),
          dropup: realm.dropup(),
          alloy: realm.system(),
          translate: noop,
        ...
        var hideDropup = function () {
          realm.dropup().disappear(function () {
            realm.system().broadcastOn([$_csmiie10ajn69h78i.dropupDismissed()], {});
          });
        };
        var backToMaskGroup = {
          label: 'The first group',
          scrollable: false,
          items: [$_8pjtl410vjn69h7fw.forToolbar('back', function () {
              editor.selection.collapse();
              realm.exit();
            }, {})]
        };
        var backToReadOnlyGroup = {
          ...
          scrollable: false,
          items: [$_8pjtl410vjn69h7fw.forToolbar('readonly-back', function () {
        ...
        var features = $_3zgsy210bjn69h78x.setup(realm, editor);
        var items = $_3zgsy210bjn69h78x.detect(editor.settings, features);
        var actionGroup = {
        ...
        $_ccjv4v17pjn69ha8g.init(realm, editor);
      });
      return {
