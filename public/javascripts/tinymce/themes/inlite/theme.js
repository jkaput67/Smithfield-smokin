...
var inlite = (function () {
  ...
  var $_5z6rcv17yjn69hbec = { flatten: flatten };
  ...
  var getSelectionRect = function (editor) {
    ...
    return clientRect ? toAbsolute($_ixgze182jn69hben.fromClientRect(clientRect)) : null;
  };
  var $_2z7b52181jn69hbek = {
    ...
    return function (editor) {
      for (var i = 0; i < predicateIds.length; i++) {
        if (predicateIds[i].predicate(element)) {
          var result = $_2qhm28180jn69hbeh.result(predicateIds[i].id, $_2z7b52181jn69hbek.getElementRect(editor, element));
          return result;
        }
      }
      return null;
      ...
      for (var i = 0; i < elements.length; i++) {
        for (var x = 0; x < predicateIds.length; x++) {
          if (predicateIds[x].predicate(elements[i])) {
            return $_2qhm28180jn69hbeh.result(predicateIds[x].id, $_2z7b52181jn69hbek.getElementRect(editor, elements[i]));
          }
        }
      }
      return null;
  ...
  var textSelection = function (id) {
    return function (editor) {
      if (!editor.selection.isCollapsed()) {
        var result = $_2qhm28180jn69hbeh.result(id, $_2z7b52181jn69hbek.getSelectionRect(editor));
        return result;
      }
      return null;
    };
      ...
      for (i = 0; i < elements.length; i++) {
        if (elements[i].nodeName in textBlockElementsMap) {
          if (editor.dom.isEmpty(elements[i])) {
            return $_2qhm28180jn69hbeh.result(id, $_2z7b52181jn69hbek.getSelectionRect(editor));
          }
          return null;
        }
      }
  ...
  var itemsToArray = function (value, defaultValue) {
    ...
    if ($_767ybu18bjn69hbf5.isArray(value)) {
      return value;
    } else if ($_767ybu18bjn69hbf5.isString(value)) {
      return stringToItemsArray(value);
    } else if ($_767ybu18bjn69hbf5.isBoolean(value)) {
  ...
  var $_ajcfjd18ajn69hbf3 = {
    getStringOr: getByTypeOr($_767ybu18bjn69hbf5.isString),
    getBoolOr: getByTypeOr($_767ybu18bjn69hbf5.isBoolean),
    getNumberOr: getByTypeOr($_767ybu18bjn69hbf5.isNumber),
    getHandlerOr: getByTypeOr($_767ybu18bjn69hbf5.isFunction),
    getToolbarItemsOr: getToolbarItemsOr($_767ybu18bjn69hbf5.isArray)
  };
  ...
  var userConstrain = function (handler, targetRect, contentAreaRect, panelRect) {
    ...
    if (typeof handler === 'function') {
      userConstrainedPanelRect = handler({
        elementRect: $_ixgze182jn69hben.toClientRect(targetRect),
        contentAreaRect: $_ixgze182jn69hben.toClientRect(contentAreaRect),
        panelRect: $_ixgze182jn69hben.toClientRect(panelRect)
      });
      return $_ixgze182jn69hben.fromClientRect(userConstrainedPanelRect);
    }
    return panelRect;
  };
  ...
  var getTextSelectionToolbarItems = function (editor) {
    return $_ajcfjd18ajn69hbf3.getToolbarItemsOr(editor, 'selection_toolbar', [
      'bold',
      'italic',
      '|',
      'quicklink',
  ...
  var getInsertToolbarItems = function (editor) {
    return $_ajcfjd18ajn69hbf3.getToolbarItemsOr(editor, 'insert_toolbar', [
      'quickimage',
      'quicktable'
    ]);
  };
  var getPositionHandler = function (editor) {
    return $_ajcfjd18ajn69hbf3.getHandlerOr(editor, 'inline_toolbar_position_handler', $_ai93mv18cjn69hbf7.defaultHandler);
  };
  ...
  var fireSkinLoaded$1 = function (editor, callback) {
    var done = function () {
      ...
      $_8y8y41187jn69hbex.fireSkinLoaded(editor);
      callback();
    };
  ...
  var load = function (editor, callback) {
    var skinUrl = $_pq4uq188jn69hbey.getSkinUrl(editor);
    var done = function () {
      fireSkinLoaded$1(editor, callback);
    };
    if ($_pq4uq188jn69hbey.isSkinDisabled(editor)) {
      done();
    } else {
  ...
  var $_dtstip186jn69hbeu = { load: load };
  ...
  var getToolbars = function (editor) {
    ...
    return $_5z6rcv17yjn69hbec.flatten([
  ...
  var findMatchResult = function (editor, toolbars) {
    ...
    contextToolbarsPredicateIds = $_2fq9vi183jn69hbep.fromContextToolbars(toolbars);
    result = $_2qhm28180jn69hbeh.match(editor, [
      $_ceri1d17zjn69hbee.element(elements[0], contextToolbarsPredicateIds),
      $_fe1vhs185jn69hber.textSelection('text'),
      $_fe1vhs185jn69hber.emptyTextBlock(elements, 'insert'),
      $_ceri1d17zjn69hbee.parent(elements, contextToolbarsPredicateIds)
    ]);
  ...
  var overrideLinkShortcut = function (editor, panel) {
    ...
    editor.shortcuts.add('meta+k', '', function () {
      var toolbars = getToolbars(editor);
      var result = $_2qhm28180jn69hbeh.match(editor, [$_fe1vhs185jn69hber.textSelection('quicklink')]);
      if (result) {
        panel.show(editor, result.id, result.rect, toolbars);
      }
    });
  ...
  var renderInlineUI = function (editor, panel) {
    $_dtstip186jn69hbeu.load(editor, function () {
  ...
  var $_8wqwdq17ujn69hbdv = { renderUI: renderUI };
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_6xrgrh18qjn69hbhf.parseBox(settings.border);
      self$$1.paddingBox = $_6xrgrh18qjn69hbhf.parseBox(settings.padding);
      self$$1.marginBox = $_6xrgrh18qjn69hbhf.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_2fxi9a18yjn69hbhv.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_6xrgrh18qjn69hbhf.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_6xrgrh18qjn69hbhf.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_6xrgrh18qjn69hbhf.measureBox(elm, 'margin');
    ...
    reflow: function () {
      $_6t39xe18xjn69hbhv.remove(this);
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_2fxi9a18yjn69hbhv.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_2fxi9a18yjn69hbhv.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_411tmp18zjn69hbib = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_2fxi9a18yjn69hbhv.getUiContainer(self$$1);
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_2fxi9a18yjn69hbhv.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_6xrgrh18qjn69hbhf.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_6xrgrh18qjn69hbhf.parseBox('0');
  ...
  var get = function (editor, panel) {
    var renderUI = function () {
      return $_8wqwdq17ujn69hbdv.renderUI(editor, panel);
    };
    return {
      renderUI: renderUI,
  ...
  var $_3qit3317tjn69hbds = { get: get };
  ...
  var $_d37mio19hjn69hbkd = { getOrDie: getOrDie };

  function FileReader () {
    var f = $_d37mio19hjn69hbkd.getOrDie('FileReader');
    return new f();
  }
  ...
  var $_1og2ap19fjn69hbk4 = { blobToBase64: blobToBase64 };
  ...
  var $_fr8j1319ljn69hbkm = { pickFile: pickFile };
  ...
  var $_ai9ab419njn69hbks = { uuid: uuid };
  ...
  var unwrapElements = function (editor, elms) {
    ...
    bookmark = $_40161d19pjn69hbkx.create(dom, selection.getRng());
    global$4.each(elms, function (elm) {
      editor.dom.remove(elm, true);
    });
    selection.setRng($_40161d19pjn69hbkx.resolve(dom, bookmark));
  };
  ...
  var $_dbvlrh19ojn69hbku = { unlinkSelection: unlinkSelection };
  ...
  var insertBlob = function (editor, base64, blob) {
    ...
    blobInfo = blobCache.create($_ai9ab419njn69hbks.uuid('mceu'), blob, base64);
  ...
  var unlink = function (editor) {
    editor.focus();
    $_dbvlrh19ojn69hbku.unlinkSelection(editor);
  ...
  var addHeaderButtons = function (editor) {
    var formatBlock = function (name) {
      return function () {
        $_4765z119mjn69hbkp.formatBlock(editor, name);
      };
    };
    for (var i = 1; i < 6; i++) {
      var name = 'h' + i;
  ...
  var addToEditor = function (editor, panel) {
    ...
    editor.addButton('quickimage', {
      ...
      onclick: function () {
        $_fr8j1319ljn69hbkm.pickFile().then(function (files) {
          var blob = files[0];
          $_1og2ap19fjn69hbk4.blobToBase64(blob).then(function (base64) {
            $_4765z119mjn69hbkp.insertBlob(editor, base64, blob);
          });
        });
      }
    });
    editor.addButton('quicktable', {
      ...
      onclick: function () {
        panel.hide();
        $_4765z119mjn69hbkp.insertTable(editor, 2, 2);
      }
    });
    addHeaderButtons(editor);
  };
  var $_31fb6r19ejn69hbk2 = { addToEditor: addToEditor };
  ...
  var $_2hdzyx19tjn69hbl6 = { getUiContainerDelta: getUiContainerDelta$1 };
  ...
  var convertLinkToAbsolute = function (editor, href) {
    return !$_1zeazs19vjn69hble.isAbsolute(href) && $_1zeazs19vjn69hble.isDomainLike(href) ? askAboutPrefix(editor, href) : global$12.resolve(href);
  };
  var createQuickLinkForm = function (editor, hide) {
    var attachState = {};
    var unlink = function () {
      editor.focus();
      $_4765z119mjn69hbkp.unlink(editor);
      hide();
    };
      ...
      onsubmit: function (e) {
        convertLinkToAbsolute(editor, e.data.linkurl).then(function (url) {
          editor.undoManager.transact(function () {
            ...
            $_4765z119mjn69hbkp.createLink(editor, url);
          });
          hide();
        });
      }
  ...
  var $_f67snj19ujn69hbla = { createQuickLinkForm: createQuickLinkForm };
  ...
  var itemsToArray$1 = function (items) {
    if ($_767ybu18bjn69hbf5.isArray(items)) {
      return items;
    } else if ($_767ybu18bjn69hbf5.isString(items)) {
      return items.split(/[ ,]/);
    }
    return [];
  };
    ...
    global$4.each(itemsToArray$1(items), function (item) {
      if (item === '|') {
        ...
        if (editor.buttons[item]) {
          ...
          if ($_767ybu18bjn69hbf5.isFunction(button)) {
            button = button();
          }
  ...
  var $_cr4uct19wjn69hblg = { create: create$2 };

  var create$3 = function () {
    var panel, currentRect;
    var createToolbars = function (editor, toolbars) {
      return global$4.map(toolbars, function (toolbar) {
        return $_cr4uct19wjn69hblg.create(editor, toolbar.id, toolbar.items);
      });
    };
    ...
    var create = function (editor, toolbars) {
      var items = createToolbars(editor, toolbars).concat([
        $_cr4uct19wjn69hblg.create(editor, 'text', $_pq4uq188jn69hbey.getTextSelectionToolbarItems(editor)),
        $_cr4uct19wjn69hblg.create(editor, 'insert', $_pq4uq188jn69hbey.getInsertToolbarItems(editor)),
        $_f67snj19ujn69hbla.createQuickLinkForm(editor, hide)
      ]);
      return global$11.create({
        type: 'floatpanel',
        role: 'dialog',
    ...
    var repositionPanelAt = function (panel, id, editor, targetRect) {
      ...
      userConstainHandler = $_pq4uq188jn69hbey.getPositionHandler(editor);
      contentAreaRect = $_2z7b52181jn69hbek.getContentAreaRect(editor);
      panelRect = global$2.DOM.getRect(panel.getEl());
      if (id === 'insert') {
        result = $_ai93mv18cjn69hbf7.calcInsert(targetRect, contentAreaRect, panelRect);
      } else {
        result = $_ai93mv18cjn69hbf7.calc(targetRect, contentAreaRect, panelRect);
      }
      if (result) {
        var delta = $_2hdzyx19tjn69hbl6.getUiContainerDelta().getOr({
          x: 0,
          y: 0
        });
        ...
        movePanelTo(panel, $_ai93mv18cjn69hbf7.userConstrain(userConstainHandler, targetRect, contentAreaRect, transposedPanelRect));
    ...
    var showForm = function (editor, id) {
      if (panel) {
        ...
        contentAreaRect = $_2z7b52181jn69hbek.getContentAreaRect(editor);
        panelRect = global$2.DOM.getRect(panel.getEl());
        result = $_ai93mv18cjn69hbf7.calc(currentRect, contentAreaRect, panelRect);
        if (result) {
          panelRect = result.rect;
          movePanelTo(panel, $_ai93mv18cjn69hbf7.userConstrain(userConstainHandler, currentRect, contentAreaRect, panelRect));
          togglePositionClass(panel, result.position);
        }
      }
    };
    var show = function (editor, id, targetRect, toolbars) {
      if (!panel) {
        $_8y8y41187jn69hbex.fireBeforeRenderUI(editor);
  ...
  var isComment = function (element) {
    return type(element) === $_66g5ls1aqjn69hbq2.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$2($_66g5ls1aqjn69hbq2.ELEMENT);
  var isText = isType$2($_66g5ls1aqjn69hbq2.TEXT);
  var isDocument = isType$2($_66g5ls1aqjn69hbq2.DOCUMENT);
  var $_e7tv421apjn69hbq0 = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_e7tv421apjn69hbq0.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_e90npd1axjn69hbsd = { toArray: toArray };

  var node = function () {
    var f = $_d37mio19hjn69hbkd.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_cg76wv1b3jn69hbtv.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_cg76wv1b3jn69hbtv.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_cg76wv1b3jn69hbtv.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_97s8lz1b7jn69hbur = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_97s8lz1b7jn69hbur.browsers();
    var oses = $_97s8lz1b7jn69hbur.oses();
    var browser = $_99322i1b6jn69hbuh.detectBrowser(browsers, userAgent).fold($_92w0w1b2jn69hbtl.unknown, $_92w0w1b2jn69hbtl.nu);
    var os = $_99322i1b6jn69hbuh.detectOs(oses, userAgent).fold($_cawd5b1b4jn69hbty.unknown, $_cawd5b1b4jn69hbty.nu);
  ...
  var $_eszs5s1b1jn69hbti = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_eszs5s1b1jn69hbti.detect(userAgent);
  });
  var $_eq8jci1b0jn69hbt6 = { detect: detect$3 };

  var ELEMENT = $_66g5ls1aqjn69hbq2.ELEMENT;
  var DOCUMENT = $_66g5ls1aqjn69hbq2.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_5qyvm81azjn69hbt4.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_eq8jci1b0jn69hbt6.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_4hrlev1ayjn69hbsi = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_9o5dii1bbjn69hbvf.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent$1(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_4hrlev1ayjn69hbsi.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_4hrlev1ayjn69hbsi.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_e90npd1axjn69hbsd.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_e90npd1axjn69hbsd.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_96rhcg1anjn69hbps.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_1d4y8h1arjn69hbq7.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_1d4y8h1arjn69hbq7.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_1d4y8h1arjn69hbq7.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_1d4y8h1arjn69hbq7.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_9o5dii1bbjn69hbvf.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_cs5rw51amjn69hbpl.ancestors(scope, function (e) {
      return $_9o5dii1bbjn69hbvf.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_cs5rw51amjn69hbpl.siblings(scope, function (e) {
      return $_9o5dii1bbjn69hbvf.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_cs5rw51amjn69hbpl.children(scope, function (e) {
      return $_9o5dii1bbjn69hbvf.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_9o5dii1bbjn69hbvf.all(selector, scope);
  };
  var $_75upiw1aljn69hbpj = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_75upiw1aljn69hbpj.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_brkfag1aijn69hbnt = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_brkfag1aijn69hbnt.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_96rhcg1anjn69hbps.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_4hrlev1ayjn69hbsi.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_9o5dii1bbjn69hbvf.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_ff8u8i1bhjn69hbwu.ancestor(scope, function (e) {
      return $_9o5dii1bbjn69hbvf.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_ff8u8i1bhjn69hbwu.sibling(scope, function (e) {
      return $_9o5dii1bbjn69hbvf.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_ff8u8i1bhjn69hbwu.child(scope, function (e) {
      return $_9o5dii1bbjn69hbvf.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_9o5dii1bbjn69hbvf.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_9o5dii1bbjn69hbvf.is, ancestor$1, scope, selector, isRoot);
  };
  var $_vi5u71bgjn69hbwr = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_d50fvb1bjjn69hbxv = { register: register };
  ...
  var $_e5abx11bljn69hbya = { register: register$1 };
  ...
  var $_ebad8u1bmjn69hbyh = { register: register$2 };
  ...
  var $_8hbxfp1bnjn69hbym = { register: register$3 };
  ...
  var $_2xa8871bojn69hbyv = { register: register$4 };
  ...
  var $_2d14251bpjn69hbz6 = { register: register$5 };
  ...
  var $_b9o2co1bqjn69hbzk = { register: register$6 };
  ...
  var $_gdjhku1brjn69hbzr = { register: register$7 };
  ...
  var $_512dfz1bsjn69hbzv = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$1.container = $_vi5u71bgjn69hbwr.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup = function (editor) {
    ...
    setupEnvironment();
    $_2xa8871bojn69hbyv.register(editor);
    $_d50fvb1bjjn69hbxv.register(editor);
    $_b9o2co1bqjn69hbzk.register(editor);
    $_gdjhku1brjn69hbzr.register(editor);
    $_ebad8u1bmjn69hbyh.register(editor);
    $_e5abx11bljn69hbya.register(editor);
    $_8hbxfp1bnjn69hbym.register(editor);
    $_512dfz1bsjn69hbzv.register(editor);
    $_2d14251bpjn69hbz6.register(editor);
  };
  var $_plawe1bfjn69hbwf = { setup: setup };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_6t39xe18xjn69hbhv,
      Control: Control$1,
      Factory: global$11,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_9wzax219bjn69hbj6,
      Panel: Panel,
      Movable: $_411tmp18zjn69hbib,
      Resizable: $_11avna19cjn69hbju,
      ...
      FormatControls: $_plawe1bfjn69hbwf,
  ...
  global.add('inlite', function (editor) {
    var panel = create$3();
    $_plawe1bfjn69hbwf.setup(editor);
    $_31fb6r19ejn69hbk2.addToEditor(editor, panel);
    return $_3qit3317tjn69hbds.get(editor, panel);
  });
  function Theme () {
  }
