...
var modern = (function () {
  ...
  var $_39wy9ou1jn69h5o2 = { addKeys: addKeys };
  ...
  var addContextualToolbars = function (editor) {
    ...
    var reposition = function (match, shouldShow) {
      ...
      var delta = $_p88g1u5jn69h5og.getUiContainerDelta(panel).getOr({
        x: 0,
        y: 0
      });
    ...
    var bindScrollEvent = function (panel) {
      if (!scrollContainer) {
        ...
        var uiContainer_1 = $_p88g1u5jn69h5og.getUiContainer(panel);
    ...
    var showContextToolbar = function (match) {
      ...
      panel = global$4.create({
        ...
        fixed: true,
        border: 1,
        items: $_bijc4cu8jn69h5ox.createToolbar(editor, match.toolbar.items),
        oncancel: function () {
          editor.focus();
        }
      });
      $_p88g1u5jn69h5og.setUiContainer(editor, panel);
  ...
  var $_g2qa4nu2jn69h5o9 = { addContextualToolbars: addContextualToolbars };
  ...
  var $_6vcvh6u9jn69h5p1 = { createMenuButtons: createMenuButtons };
  ...
  var resizeTo = function (editor, width, height) {
    ...
    $_acoichu0jn69h5nz.fireResizeEditor(editor);
  };
  var resizeBy = function (editor, dw, dh) {
    var elm = editor.getContentAreaContainer();
    resizeTo(editor, elm.clientWidth + dw, elm.clientHeight + dh);
  };
  var $_3ddkqucjn69h5pg = {
    resizeTo: resizeTo,
    resizeBy: resizeBy
  };
  ...
  var fireSkinLoaded$1 = function (editor) {
    var done = function () {
      ...
      $_acoichu0jn69h5nz.fireSkinLoaded(editor);
    };
    return function () {
      if (editor.initialized) {
        done();
  ...
  var $_9ai1u9ufjn69h5pn = { fireSkinLoaded: fireSkinLoaded$1 };
  ...
  var editAreaContainer = function (editor) {
    return {
      ...
      items: [
        editArea('0'),
        $_dqtspqudjn69h5pj.createSidebar(editor)
      ]
    };
  };
  var render = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM$2.styleSheetLoader.load(args.skinUiCss, $_9ai1u9ufjn69h5pn.fireSkinLoaded(editor));
    } else {
      $_9ai1u9ufjn69h5pn.fireSkinLoaded(editor)();
    }
      ...
      items: [
        {
          ...
          items: [
            hasMenubar(editor) === false ? null : {
              type: 'menubar',
              border: '0 0 1 0',
              items: $_6vcvh6u9jn69h5p1.createMenuButtons(editor)
            },
            $_bijc4cu8jn69h5ox.createToolbars(editor, getToolbarSize(editor))
          ]
        },
        $_dqtspqudjn69h5pj.hasSidebar(editor) ? editAreaContainer(editor) : editArea('1 0 0 0')
      ]
    });
    $_p88g1u5jn69h5og.setUiContainer(editor, panel);
      ...
      resizeHandleCtrl = {
        ...
        onResize: function (e) {
          if (getResize(editor) === 'both') {
            $_3ddkqucjn69h5pg.resizeTo(editor, startSize.width + e.deltaX, startSize.height + e.deltaY);
          } else {
            $_3ddkqucjn69h5pg.resizeTo(editor, null, startSize.height + e.deltaY);
          }
        }
      };
    }
    ...
    $_acoichu0jn69h5nz.fireBeforeRenderUI(editor);
    ...
    $_39wy9ou1jn69h5o2.addKeys(editor, panel);
    $_g2qa4nu2jn69h5o9.addContextualToolbars(editor);
    return {
      iframeContainer: panel.find('#iframe')[0].getEl(),
      editorContainer: panel.getEl()
    };
  };
  var $_dsjp33twjn69h5nr = { render: render };
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_p88g1u5jn69h5og.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_p88g1u5jn69h5og.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_4vh55culjn69h5qr = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_p88g1u5jn69h5og.getUiContainer(self$$1);
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_45pxjnurjn69h5re.parseBox(settings.border);
      self$$1.paddingBox = $_45pxjnurjn69h5re.parseBox(settings.padding);
      self$$1.marginBox = $_45pxjnurjn69h5re.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_p88g1u5jn69h5og.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_45pxjnurjn69h5re.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_45pxjnurjn69h5re.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_45pxjnurjn69h5re.measureBox(elm, 'margin');
  ...
  var render$1 = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM.styleSheetLoader.load(args.skinUiCss, $_9ai1u9ufjn69h5pn.fireSkinLoaded(editor));
    } else {
      $_9ai1u9ufjn69h5pn.fireSkinLoaded(editor)();
    }
    return {};
  };
  var $_ab2sl4ugjn69h5pp = { render: render$1 };
  ...
  var $_c0q2oiv3jn69h5sp = { setup: setup };
  ...
  var renderUI = function (editor, theme, args) {
    ...
    $_c0q2oiv3jn69h5sp.setup(editor, theme);
    return isInline(editor) ? $_ab2sl4ugjn69h5pp.render(editor, theme, args) : $_dsjp33twjn69h5nr.render(editor, theme, args);
  };
  var $_72bhcstsjn69h5nh = { renderUI: renderUI };

  var Tooltip = Control$1.extend({
    Mixins: [$_4vh55culjn69h5qr],
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_p88g1u5jn69h5og.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_45pxjnurjn69h5re.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_45pxjnurjn69h5re.parseBox('0');
  ...
  var get = function (editor) {
    var renderUI = function (args) {
      return $_72bhcstsjn69h5nh.renderUI(editor, this, args);
    };
    var resizeTo = function (w, h) {
      return $_3ddkqucjn69h5pg.resizeTo(editor, w, h);
    };
    var resizeBy = function (dw, dh) {
      return $_3ddkqucjn69h5pg.resizeBy(editor, dw, dh);
    };
  ...
  var isComment = function (element) {
    return type(element) === $_fje41ww6jn69h5xa.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_fje41ww6jn69h5xa.ELEMENT);
  var isText = isType$1($_fje41ww6jn69h5xa.TEXT);
  var isDocument = isType$1($_fje41ww6jn69h5xa.DOCUMENT);
  var $_52oy15w5jn69h5xa = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_52oy15w5jn69h5xa.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_eempqswdjn69h5y5 = { toArray: toArray };
  ...
  var $_7o9siewgjn69h5z1 = { getOrDie: getOrDie };

  var node = function () {
    var f = $_7o9siewgjn69h5z1.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_9tx0btwmjn69h5zg.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_9tx0btwmjn69h5zg.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_9tx0btwmjn69h5zg.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_4198wewqjn69h60c = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_4198wewqjn69h60c.browsers();
    var oses = $_4198wewqjn69h60c.oses();
    var browser = $_bs6wk1wpjn69h605.detectBrowser(browsers, userAgent).fold($_c43kdswljn69h5zg.unknown, $_c43kdswljn69h5zg.nu);
    var os = $_bs6wk1wpjn69h605.detectOs(oses, userAgent).fold($_gfxdhtwnjn69h5zg.unknown, $_gfxdhtwnjn69h5zg.nu);
  ...
  var $_6xkj5xwkjn69h5zg = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_6xkj5xwkjn69h5zg.detect(userAgent);
  });
  var $_63aj8dwjjn69h5z1 = { detect: detect$3 };

  var ELEMENT = $_fje41ww6jn69h5xa.ELEMENT;
  var DOCUMENT = $_fje41ww6jn69h5xa.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_ea2rtuwfjn69h5yl.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_63aj8dwjjn69h5z1.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_e4s31jwejn69h5y5 = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_e4hf31wujn69h60h.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_e4s31jwejn69h5y5.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_e4s31jwejn69h5y5.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_eempqswdjn69h5y5.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_eempqswdjn69h5y5.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_2ynlmpw3jn69h5wv.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_7pdopjw7jn69h5xa.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_7pdopjw7jn69h5xa.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_7pdopjw7jn69h5xa.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_7pdopjw7jn69h5xa.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_e4hf31wujn69h60h.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_364zd9w2jn69h5wv.ancestors(scope, function (e) {
      return $_e4hf31wujn69h60h.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_364zd9w2jn69h5wv.siblings(scope, function (e) {
      return $_e4hf31wujn69h60h.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_364zd9w2jn69h5wv.children(scope, function (e) {
      return $_e4hf31wujn69h60h.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_e4hf31wujn69h60h.all(selector, scope);
  };
  var $_cj5y3fw1jn69h5wv = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_cj5y3fw1jn69h5wv.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_93dmfcvyjn69h5vk = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_93dmfcvyjn69h5vk.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_2ynlmpw3jn69h5wv.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_e4s31jwejn69h5y5.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_e4hf31wujn69h60h.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_3njn1wx0jn69h61t.ancestor(scope, function (e) {
      return $_e4hf31wujn69h60h.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_3njn1wx0jn69h61t.sibling(scope, function (e) {
      return $_e4hf31wujn69h60h.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_3njn1wx0jn69h61t.child(scope, function (e) {
      return $_e4hf31wujn69h60h.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_e4hf31wujn69h60h.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_e4hf31wujn69h60h.is, ancestor$1, scope, selector, isRoot);
  };
  var $_2jt0zkwzjn69h61c = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_ea2gg8x2jn69h62f = { register: register };
  ...
  var $_ce7v1tx4jn69h62u = { register: register$1 };
  ...
  var $_dxl8uux5jn69h62u = { register: register$2 };
  ...
  var $_all21gx6jn69h62u = { register: register$3 };
  ...
  var $_82dmbjx7jn69h62u = { register: register$4 };
  ...
  var $_32dsefx8jn69h62u = { register: register$5 };
  ...
  var $_1l6qtqx9jn69h63a = { register: register$6 };
  ...
  var $_3xgw3wxajn69h63a = { register: register$7 };
  ...
  var $_eb053uxbjn69h63a = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$8.container = $_2jt0zkwzjn69h61c.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup$1 = function (editor) {
    ...
    setupEnvironment();
    $_82dmbjx7jn69h62u.register(editor);
    $_ea2gg8x2jn69h62f.register(editor);
    $_1l6qtqx9jn69h63a.register(editor);
    $_3xgw3wxajn69h63a.register(editor);
    $_dxl8uux5jn69h62u.register(editor);
    $_ce7v1tx4jn69h62u.register(editor);
    $_all21gx6jn69h62u.register(editor);
    $_eb053uxbjn69h63a.register(editor);
    $_32dsefx8jn69h62u.register(editor);
  };
  var $_40ay8rwyjn69h60w = { setup: setup$1 };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_gadhgmuyjn69h5s9,
      Control: Control$1,
      Factory: global$4,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_8lyu71v0jn69h5sp,
      Panel: Panel,
      Movable: $_4vh55culjn69h5qr,
      Resizable: $_456h3uv2jn69h5sp,
      ...
      FormatControls: $_40ay8rwyjn69h60w,
  ...
  global.add('modern', function (editor) {
    $_40ay8rwyjn69h60w.setup(editor);
    return $_e32xlqtrjn69h5ne.get(editor);
  });
  function Theme () {
  }
